<?php 
/*
Plugin Name: DMC Comment Notification
Plugin URI: 
Description: Overrides the WP Notify Moderator function. If it finds a WP option_name called commentmod_email and if it holds an email address, all the moderation comment notifications are sent to that email address.
...
function wp_notify_moderator($comment_id) {
	...
	@wp_mail($wpmoderator_email, $subject, $notify_message);
