...
class asnt_upcoming_events extends WP_Widget {
	function __construct() {
		parent::__construct(
		// widget ID
		'asnt_upcoming_events',
		// widget name
		__('ASNT Upcoming Events', ' asnt_upcoming_events_domain'),
		// widget description
		array( 'description' => __( 'Widget for displaying Upcoming Events.', 'asnt_upcoming_events_domain' ), )
		);
		}
							...
							<div class="top-stories-area">
								...
								<div class="top-stories-description">
									...
									<p class="post-date">
										...
										<?php } else{ print $evnt_startdate  .' - '.  $evnt_starttime;} ?>
									</p>
								</div>
							</div>
						</a>
