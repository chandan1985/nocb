...
class asnt_category_wise_slideshow_posts_sidebar extends WP_Widget {
	function __construct() {
		parent::__construct(
		// widget ID
		'asnt_category_wise_slideshow_posts_sidebar',
		// widget name
		__('ASNT Category wise slideshow posts', ' asnt_category_wise_slideshow_posts_sidebar_domain'),
		// widget description
		array( 'description' => __( 'Widget for displaying multiple data of particular category in slideshow.', 'asnt_category_wise_slideshow_posts_sidebar_domain' ), )
		);
		}
        ...
        <div class="featuredContent_slideshow" style="display:none">
            <?php
					...
					foreach ($postsbyid as $post_id) {
						...
						$short_content = substr($content,0,125) . "[...]";			
							?>
