...
jQuery.fn.select2.amd.define('select2/selection/customSelectionAdapter',
  [
    'jquery',
    'select2/selection/base',
    'select2/selection/eventRelay',
    'select2/utils',
  ], function (jQuery, BaseSelection, EventRelay, Utils) {
    ...
    CustomSelection.prototype.render = function () {
      ...
      this.$selectionTagsContainer = jQuery(
    ...
    CustomSelection.prototype.update = function (data) {
      ...
      // AJK - Appendmany is not in more current versions of select2.  
...
(function() {
  ...
  var Placeholder = jQuery.fn.select2.amd.require('select2/selection/placeholder');
  var AllowClear = jQuery.fn.select2.amd.require('select2/selection/allowClear');
  var SelectionSearch = jQuery.fn.select2.amd.require('select2/selection/search');
