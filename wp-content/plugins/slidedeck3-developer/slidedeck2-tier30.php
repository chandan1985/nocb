<?php
/*
Plugin Name: SlideDeck 3 - Developer Addon Package
Plugin URI: http://demo.slidedeck.com
Description: Developer level addons for SlideDeck 3
Version: 4.5.1
Author: SlideDeck
...
if( !defined( "SLIDEDECK2_DEVELOPER_VERSION" ) ) define( "SLIDEDECK2_DEVELOPER_VERSION", "4.5.1" );
...
class SlideDeckPluginDeveloper {
    ...
    static $st_friendly_name = "SlideDeck 3 Developer Addon";
...
add_action( 'plugins_loaded', array( 'SlideDeckPluginDeveloper', 'instance' ), 30 );
	...
	add_action( 'load-plugins.php', 'slidedeck_developer_filter'	);
	
	function slidedeck_developer_filter(){
        add_filter( 'gettext', 'slidedeck_developer_gettext', 99, 3 );
    }
	
	function slidedeck_developer_gettext( $translated_text, $untranslated_text, $domain )
	{
		$old = array(
		...
		$new = "Please delete <b>SlideDeck 2 Developer Addon</b> first and then Install <b>SlideDeck 3 Developer Addon</b>";
