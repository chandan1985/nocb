        ...
        ?>
            ...
            <table class="form-table meta">
                ...
                <tbody>
                    ...
                    <tr id="slidedeck-lens-content-sources">
                        ...
                        <td>
    	                    <fieldset>
								...
								<?php 
								// dont show custom option for polarad
								if( $lens['slug'] === "polarad" && $source->name === "custom"){
									continue;
								}
								?>
					...
					<?php if( $lens['slug'] === "polarad" ) {?>
					<tr>
						<th scope="row"><?php _e( "Note:", $namespace ); ?></th>
						<td>
							<p style="display: inline-block;background-color: #fff;padding: 5px 20px;border-radius: 5px;">This lens is not supporting custom slides</p>
						</td>
					</tr>
					<?php } ?>
                    <tr>
