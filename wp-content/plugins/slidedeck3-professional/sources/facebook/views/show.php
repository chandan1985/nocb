    ...
    <div class="inner">
        <ul class="content-source-fields">
            ...
            <li>
                ...
                <em class="note-below">Facebook expires access tokens after 60 days, we will still display your cached content in the event that your access token expires.<br/><br/>Get your access token <a target="_blank" href="https://developers.facebook.com/tools/accesstoken/">here</a>.</em>
                    <!-- <a href="<?php echo admin_url( 'admin-ajax.php' ); ?>?action=<?php echo $namespace; ?>_get_facebook_access_token&_wpnonce_get_facebook_access_token=<?php echo wp_create_nonce( $namespace . '-get-facebook-access-token' ); ?>" id="get-facebook-access-token-link">here</a>.</em> -->
            </li>
        </ul>
    </div>
</div>