<?php
/*
Plugin Name: SlideDeck 3 - Professional Addon Package
Plugin URI: http://demo.slidedeck.com/
Description: Professional level addons for SlideDeck 3
Version: 4.5.1
Author: SlideDeck
...
if( !defined( "SLIDEDECK2_PROFESSIONAL_VERSION" ) ) define( "SLIDEDECK2_PROFESSIONAL_VERSION", "4.5.1" );
...
class SlideDeckPluginProfessional {
    ...
    static $st_friendly_name = "SlideDeck 3 Professional Addon";
    ...
    static function activate() {
        ...
        if( !defined( 'SLIDEDECK2_DIRNAME' ) ) {
            die( "<strong>ERROR:</strong> SlideDeck 3 Personal is required for this plugin to be installed" );
        }
    ...
    function admin_print_scripts() {
        ...
        wp_enqueue_script( 'codemirror-slidedeck' );
    ...
    function wp_register_scripts() {
        ...
        // Change register handle so it will not conflict with other plugins.
        wp_register_script( "codemirror-slidedeck", SLIDEDECK2_PROFESSIONAL_URLPATH . "/js/codemirror/codemirror.js", array(), '2.25', true );
...
add_action( 'plugins_loaded', array( 'SlideDeckPluginProfessional', 'instance' ), 20 );
	...
	add_action( 'load-plugins.php', 'slidedeck_professional_filter'	);
	
	function slidedeck_professional_filter(){
        add_filter( 'gettext', 'slidedeck_professional_gettext', 99, 3 );
    }
	
	function slidedeck_professional_gettext( $translated_text, $untranslated_text, $domain )
	{
		$old = array(
		...
		$new = "Please delete <b>SlideDeck 2 Professional Addon</b> first and then Install <b>SlideDeck 3 Professional Addon</b>";
