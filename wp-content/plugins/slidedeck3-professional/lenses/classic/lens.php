...
class SlideDeckLens_Classic extends SlideDeckLens_Scaffold {
    var $options_model = array(
        ...
        'Navigation' => array(
			...
			"vertical"=>"Horizontal"	
                ...
                'label' => "Spine Position",
                'description' => "Spine position as vertical or horizontal.",
		'weight' => -4	
            ),
            'spineWidth' => array(
                'type' => 'text',
	...
	if($slidedeck['options']['spinePosition'] == 'horizontal'){
		$classes[] = "sd2-spinePosition-horizontal";
	}
	else if($slidedeck['options']['spinePosition'] == 'vertical'){
		$classes[] = "sd2-spinePosition-vertical";
	}
    ...
    function slidedeck_spine_styles( $styles, $slidedeck, $slide ){
	    ...
	    if($slidedeck['options']['spinePosition'] == 'horizontal'){
            	$styles .= 'height:' . $slidedeck['options']['spineWidth'] . 'px'; 
		            ...
		            $styles .= 'width:' . $slidedeck['options']['spineWidth'] . 'px'; 
			    $styles .= ','.'height:' . $slidedeck['options']['height'] . 'px'; 	
	    }
        }
