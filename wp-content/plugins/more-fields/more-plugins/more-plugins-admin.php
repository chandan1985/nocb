...
/*
		...
		*/
		function plugin_row_meta ($links, $file) {
			if (strpos('padding' . $file, $this->slug)) {
				...
				$links[] = '<a href="https://more-plugins.se/forum/forum/' . $this->slug . '/">' . __('Support','more-plugins') . '</a>';
				$links[] = '<a href="https://more-plugins.se/donate/">' . __('Donate','sitemap') . '</a>';
			}
			return $links;
		}
		...
		function admin_head () {
			...
			/* <![CDATA[ */
				(function() {
					...
					s.src = '<?php echo WP_PLUGIN_URL; ?>/more-fields/loader.js';
		...
		*/
		function request_handler () {
			...
			if (!empty($this->keys) && count($this->keys) && $this->action == 'add') {
						...
						<div id="side-sortables" class="meta-box-sortabless ui-sortable" style="position:relative;">
							...
							<div id="<?php echo $this->slug; ?>-information" class="postbox">
								...
								<div class="inside">
									...
									<ul>
										<li><a href="https://more-plugins.se/plugins/<?php echo $this->slug; ?>/">Plugin homepage</a></li>
										<li><a href="https://more-plugins.se/forum/">Plugin support forum</a></li>
										<li><a href="https://wordpress.org/tags/<?php echo $this->slug; ?>?forum_id=10">Wordpress Forum</a></li>
