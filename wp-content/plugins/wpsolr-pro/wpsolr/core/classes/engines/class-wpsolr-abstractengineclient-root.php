...
abstract class WPSOLR_AbstractEngineClient_Root {
	...
	function get_facet_hierarchy_name(
		...
		$result = ( $is_hierarchy || ( $this->_get_is_taxonomy_hierarchical( $facet_name ) && ( WpSolrSchema::_FIELD_NAME_NON_FLAT_HIERARCHY === $hierarchy_field_name ) ) ) ? sprintf( $hierarchy_field_name, $facet_name ) : $facet_name;
