...
use wpsolr\pro\classes\ui\widget\WPSOLR_Widget_Recommendation;
		...
		add_action( 'widgets_init', function () {
			...
			foreach (
				[
					...
					WPSOLR_Option_Recommendations::IS_RECOMMENDATIONS_IMPLEMENTED ? WPSOLR_Widget_Recommendation::class : null,
