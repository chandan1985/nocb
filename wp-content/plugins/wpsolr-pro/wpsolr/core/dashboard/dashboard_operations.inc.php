...
$is_engine_google_retail = WPSOLR_AbstractEngineClient::ENGINE_GOOGLE_RETAIL === $search_engine->get_config()['index_engine'];
if ( $is_engine_google_retail ) {
	$delete_confirmation_message = <<<EOF

This action can be very costly and slow !!

Google Retail API cannot delete products all at once, but requires as many calls as there are products.
You can instead purge your catalog https://cloud.google.com/retail/docs/upload-catalog#purge

Do you confirm the deletion of your products?
EOF;
}
