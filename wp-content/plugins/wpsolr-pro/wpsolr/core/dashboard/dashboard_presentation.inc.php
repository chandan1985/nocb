...
<ol>
    <li>
        ...
        <ul>
            <br>
            Or use some paid services for:
			<?php foreach (
				[
					'Apache Solr hosting'       => 'https://www.wpsolr.com/guide/configuration-step-by-step-schematic/apache-solr-hosting/',
					'Elasticsearch hosting'     => 'https://www.wpsolr.com/guide/configuration-step-by-step-schematic/elasticsearch-hosting/',
					'OpenSearch Amazon hosting' => 'https://www.wpsolr.com/guide/configuration-step-by-step-schematic/configure-your-indexes/create-an-amazon-aws-opensearch-index/',
				] as $search_engine_name => $search_engine_url
			) { ?>
                <li>
                    <a href="<?php WPSOLR_Escape::echo_esc_url( $license_manager->add_campaign_to_url( $search_engine_url ) ); ?>"
                       target="<?php WPSOLR_Escape::echo_esc_attr( $search_engine_name ); ?>"><?php WPSOLR_Escape::echo_esc_html( $search_engine_name ); ?>
                    </a>
                </li>
			<?php } ?>
