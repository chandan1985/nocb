<div id="solr-option-tab">
	...
	if ( ! WPSOLR_Option_Recommendations::IS_RECOMMENDATIONS_IMPLEMENTED ) {
		unset( $subtabs['recommendation_opt'] );
	}
        ...
        <div id="solr-results-options" class="wdm-vertical-tabs-content">
            <form action="options.php" method="POST" id='res_settings_form'>
                ...
                <div class='wrapper'>
                    ...
                    <?php WPSOLR_Escape::echo_esc_attr( WPSOLR_AbstractEngineClient::ENGINE_ALGOLIA ); ?>
                    <?php WPSOLR_Escape::echo_esc_attr( WPSOLR_AbstractEngineClient::ENGINE_GOOGLE_RETAIL ); ?>
                    ">
                        <div class='col_left'>
                            Use a visitor cookie to personalize search
                        </div>
                        <div class='col_right'>
                            <label>
                                <input type='checkbox'
                                       class='wpsolr_collapser'
                                       name='<?php WPSOLR_Escape::echo_esc_attr( $view_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEARCH_IS_USE_FIRST_PARTY_COOKIE ); ?>]'
                                       value='is_active'
									<?php checked( WPSOLR_Service_Container::getOption()->get_is_search_use_first_party_cookie() ); ?>>
                                <span class='wpsolr_collapsed'>
                            The cookie's name is "<?php WPSOLR_Escape::echo_esc_html( WPSOLR_AbstractEngineClient::WPSOLR_COOKIE_NAME ); ?>".<br/>
                            It is compliant: a first party cookie sending no private user information.
                            The visitor id is an anonymous identifier generated by WPSOLR. like "e79f89b1-ae80-4518-aeb5-0fc1b1e24471".<br/>
                            It is independant from WP or WooCommerce login cookies.<br/>
                            It is used by the search to train an AI model to improve search results quality.<br/>
                        </span>
                            </label>
                        </div>
                        <div class="clear"></div>
