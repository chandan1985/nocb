...
class WPSOLR_Search_Recombee_Client extends WPSOLR_AbstractSearchClient {
	...
	const QUERY_SUGGESTIONS_NOT_SUPPORTED_BY_YOUR_ALGOLIA_PLAN = 'Query suggestions not supported by your Recombee plan.';

	const ERROR_MSG_RANDOM_SORT_IS_NOT_SUPPORTED_BY_ALGOLIA = 'Random sort is not supported by Recombee.';
	 ...
	 *
	 * @param \Recombee\RecombeeSearch\SearchClient $search_engine_client
	 *
	 * @return WPSOLR_Results_Recombee_Client
	 * @throws \Exception
	 */
	public function search_engine_client_execute( $search_engine_client, $random_score ) {
		...
		$results = new WPSOLR_Results_Recombee_Client( $raw_results );
	...
	protected function _search( $index_name ) {
		...
		// Get Recommendations
		return $this->search_engine_client->send( new RecommendItemsToItem( (string) 98, $user_id, $this->search_parameters['length'], [
			// optional parameters:
			'scenario'         => $this->get_recommendation()[ WPSOLR_Option::OPTION_RECOMMENDATION_RECOMBEE_SCENARIO ],
			'cascadeCreate'    => false,
			'returnProperties' => true,
			//'includedProperties' => true,

			//'filter'           => $filters,
			'filter'           => $this->queries[0]['filters'],
	...
	protected function admin_is_index_exists( $is_throw_error = false ) {
		...
		try {
			...
			// No ping available : use a query on items.
			$this->search_engine_client->send( new ListItems( [ 'count' => 0 ] ) );
	...
	public function search_engine_client_set_start( $start ) {
		// https://www.recombee.com/doc/api-reference/api-parameters/offset/
	...
	public function search_engine_client_set_rows( $rows ) {
		// https://www.recombee.com/doc/api-reference/api-parameters/length/
	...
	public function search_engine_client_add_sort_random( $seed ) {
		// https://www.recombee.com/doc/faq/indexing/how-to-randomize-results/
	 ...
	 * @inherit
	 *
	 * https://www.recombee.com/doc/api-reference/api-parameters/filters/
	 *
	 * @return string
	 */
	...
	public function search_engine_client_create_filter_wildcard( $field_name, $field_value ) {
		// Not used. The "LIKE" search filter is not supported by Recombee.
		return '';
	}
	...
	public function search_engine_client_create_filter_wildcard_not( $field_name, $field_value ) {
		// Not used. The "NOT LIKE" search filter is not supported by Recombee.
		return '';
	}
	...
	public function search_engine_client_create_filter_no_values( $field_name ) {
		// Not supported by Recombee: https://www.recombee.com/doc/guides/managing-results/refine-results/filtering/how-to/filter-by-null-or-missing-attributes/
		return '';
	}
	...
	public function search_engine_client_create_not( $query ) {
		// Recombee forbids NOT (A AND B), just (NOT A OR NOT B)

		return sprintf( '(NOT %s)', $query );
	}
	...
	function search_engine_client_set_highlighting(
		...
		// https://www.recombee.com/doc/api-reference/api-parameters/attributesToHighlight/
	 ...
	 * @inheritDoc
	 *
	 * https://www.recombee.com/doc/api-reference/api-parameters/facets/
	 */
	protected
	...
	function search_engine_client_set_facets_limit(
		...
		// https://www.recombee.com/doc/api-reference/api-parameters/maxValuesPerFacet/
	...
	function search_engine_client_set_facet_sort_alphabetical(
		...
		// https://www.recombee.com/doc/api-reference/api-parameters/sortFacetValuesBy/
	...
	public function search_engine_client_set_fields( $fields ) {
		...
		// https://www.recombee.com/doc/api-reference/api-parameters/attributesToRetrieve/
	...
	public function search_engine_client_get_suggestions_keywords( $suggestion, $query, $contexts, $is_error = false ) {
		...
		// https://www.recombee.com/doc/guides/getting-insights-and-analytics/leveraging-analytics-data/query-suggestions/
	...
	/**
	 * https://www.recombee.com/doc/guides/managing-results/relevance-overview/in-depth/ranking-criteria/#geo-if-applicable
	 *
	 * @inheritDoc
	 */
	...
	public function get_named_geodistance_query_for_field( $field_prefix, $field_name, $geo_latitude, $geo_longitude ) {
		// Recombee does not provide a distance
		return null;
	}
	 ...
	 *
	 * @return array
	 * @link https://www.recombee.com/doc/api-reference/api-parameters/distinct/
	 *
	 */
	protected
	...
	public function _create_filter_range( $upper_operation, $filter_name, $field_name, $facet_is_or, $range_start, $range_end, $is_date, $filter_tag = '' ) {
		...
		if ( ( '*' !== $range_start ) && ( '*' !== $range_end ) ) {
			/**
			 * As Recombee cannot stand (A >= 1 AND A <= 2) OR (A >= 2 AND A <= 3), we use instead (A:1 TO 1.99999) OR (A:2 TO 2.999999)
			 * https://www.recombee.com/doc/api-reference/api-parameters/filters/#boolean-operators
			 */
	...
	public function search_engine_client_add_filter_geolocation_distance( $field_name, $geo_latitude, $geo_longitude, $distance ) {
		...
		// https://www.recombee.com/doc/guides/managing-results/refine-results/geolocation/how-to/filter-results-around-a-location/
		// https://www.recombee.com/doc/api-reference/api-parameters/aroundRadius/
	...
	function search_engine_client_event_tracking_set_is_return_query_id(
		...
		// https://www.recombee.com/doc/api-reference/api-parameters/clickAnalytics/
	...
	function search_engine_client_event_tracking_set_user_is_personalization(
		...
		// https://www.recombee.com/doc/api-reference/api-parameters/enablePersonalization/
		$this->search_parameters['enablePersonalization'] = $is_personalization;

		// https://www.recombee.com/doc/api-reference/api-parameters/personalizationImpact/
		//$this->search_parameters['personalizationImpact'] = 20;

		// https://www.recombee.com/doc/api-reference/api-parameters/analyticsTags/
		//$this->search_parameters['analyticsTags'] = [
		//    'front_end',
		//    'website2'
		//  ];

		// https://www.recombee.com/doc/api-reference/api-parameters/enableReRanking/
	}
	...
	public function search_engine_client_event_tracking_set_user_token( $user_token ) {
		// https://www.recombee.com/doc/api-reference/api-parameters/userToken/
