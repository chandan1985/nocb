...
class WPSOLR_Results_Amazon_Personalize_Client extends WPSOLR_AbstractResultsClient {
	...
	/**
	 * WPSOLR_Results_Amazon_Personalize_Client constructor.
	 *
	 * @param array $results
	 */
	...
	public function get_suggestions() {
		...
		$suggests_array = [];
		if ( isset( $suggests[ WPSOLR_Search_Amazon_Personalize_Client::SUGGESTER_NAME ] ) ) {
			foreach ( $suggests[ WPSOLR_Search_Amazon_Personalize_Client::SUGGESTER_NAME ][0]['options'] as $option ) {
