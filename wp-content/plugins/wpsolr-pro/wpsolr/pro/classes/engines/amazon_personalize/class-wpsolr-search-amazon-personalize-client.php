...
use Amazon_Personalize\RecommApi\Requests\ListItems;
...
class WPSOLR_Search_Amazon_Personalize_Client extends WPSOLR_AbstractSearchClient {
	use WPSOLR_Amazon_Personalize_Client;
	...
	const QUERY_SUGGESTIONS_NOT_SUPPORTED_BY_YOUR_ALGOLIA_PLAN = 'Query suggestions not supported by your Amazon_Personalize plan.';

	const ERROR_MSG_RANDOM_SORT_IS_NOT_SUPPORTED_BY_ALGOLIA = 'Random sort is not supported by Amazon_Personalize.';
	 ...
	 *
	 * @param \Amazon_Personalize\Amazon_PersonalizeSearch\SearchClient $search_engine_client
	 *
	 * @return WPSOLR_Results_Amazon_Personalize_Client
	 * @throws \Exception
	 */
	public function search_engine_client_execute( $search_engine_client, $random_score ) {
		...
		$results = new WPSOLR_Results_Amazon_Personalize_Client( $raw_results );
	...
	protected function admin_is_index_exists( $is_throw_error = false ) {
		...
		try {
			...
			// 	$dataset_group_arn = 'arn:aws:personalize:us-east-1:299331723394:dataset-group/dataset-group-1';

			/**
			 * Check that the previous dataset group still exists
			 */
			if ( ! empty( $dataset_group_arn = $this->config['extra_parameters']['dataset_group_arn'] ?? '' ) ) {
				/**
				 * https://docs.aws.amazon.com/aws-sdk-php/v3/api/api-personalize-2018-05-22.html#describedatasetgroup
				 */
				$dataset_group = $this->search_engine_client->describeDatasetGroup( [ 'datasetGroupArn' => $dataset_group_arn, ] );

				// No exception: the dataset group exists and is ACTIVE
				return true;
			}

			throw new \Exception( 'The dataset group could not be found nor created.' );
	...
	public function search_engine_client_set_start( $start ) {
		// https://www.amazon_personalize.com/doc/api-reference/api-parameters/offset/
	...
	public function search_engine_client_set_rows( $rows ) {
		// https://www.amazon_personalize.com/doc/api-reference/api-parameters/length/
	...
	public function search_engine_client_add_sort_random( $seed ) {
		// https://www.amazon_personalize.com/doc/faq/indexing/how-to-randomize-results/
		throw new \Exception( self::ERROR_MSG_RANDOM_SORT_IS_NOT_SUPPORTED_BY_ALGOLIA );
	}
	 ...
	 * @inherit
	 *
	 * https://www.amazon_personalize.com/doc/api-reference/api-parameters/filters/
	 *
	 * @return string
	 */
	...
	public function search_engine_client_create_filter_wildcard( $field_name, $field_value ) {
		// Not used. The "LIKE" search filter is not supported by Amazon_Personalize.
		return '';
	}
	...
	public function search_engine_client_create_filter_wildcard_not( $field_name, $field_value ) {
		// Not used. The "NOT LIKE" search filter is not supported by Amazon_Personalize.
		return '';
	}
	...
	public function search_engine_client_create_filter_no_values( $field_name ) {
		// Not supported by Amazon_Personalize: https://www.amazon_personalize.com/doc/guides/managing-results/refine-results/filtering/how-to/filter-by-null-or-missing-attributes/
		return '';
	}
	...
	public function search_engine_client_create_not( $query ) {
		// Amazon_Personalize forbids NOT (A AND B), just (NOT A OR NOT B)
	...
	function search_engine_client_set_highlighting(
		...
		// https://www.amazon_personalize.com/doc/api-reference/api-parameters/attributesToHighlight/
	 ...
	 * @inheritDoc
	 *
	 * https://www.amazon_personalize.com/doc/api-reference/api-parameters/facets/
	 */
	protected
	...
	function search_engine_client_set_facets_min_count(
		...
		// Not implemented in amazon_personalize
	...
	function search_engine_client_set_facets_limit(
		...
		// https://www.amazon_personalize.com/doc/api-reference/api-parameters/maxValuesPerFacet/
	...
	function search_engine_client_set_facet_sort_alphabetical(
		...
		// https://www.amazon_personalize.com/doc/api-reference/api-parameters/sortFacetValuesBy/
	...
	public function search_engine_client_set_fields( $fields ) {
		...
		// https://www.amazon_personalize.com/doc/api-reference/api-parameters/attributesToRetrieve/
	...
	public function search_engine_client_get_suggestions_keywords( $suggestion, $query, $contexts, $is_error = false ) {
		...
		// https://www.amazon_personalize.com/doc/guides/getting-insights-and-analytics/leveraging-analytics-data/query-suggestions/
		throw new \Exception( self::QUERY_SUGGESTIONS_NOT_SUPPORTED_BY_YOUR_ALGOLIA_PLAN );
	}
	...
	/**
	 * https://www.amazon_personalize.com/doc/guides/managing-results/relevance-overview/in-depth/ranking-criteria/#geo-if-applicable
	 *
	 * @inheritDoc
	 */
	...
	public function get_named_geodistance_query_for_field( $field_prefix, $field_name, $geo_latitude, $geo_longitude ) {
		// Amazon_Personalize does not provide a distance
		return null;
	}
	 ...
	 *
	 * @return array
	 * @link https://www.amazon_personalize.com/doc/api-reference/api-parameters/distinct/
	 *
	 */
	protected
	...
	public function _create_filter_range( $upper_operation, $filter_name, $field_name, $facet_is_or, $range_start, $range_end, $is_date, $filter_tag = '' ) {
		...
		if ( ( '*' !== $range_start ) && ( '*' !== $range_end ) ) {
			/**
			 * As Amazon_Personalize cannot stand (A >= 1 AND A <= 2) OR (A >= 2 AND A <= 3), we use instead (A:1 TO 1.99999) OR (A:2 TO 2.999999)
			 * https://www.amazon_personalize.com/doc/api-reference/api-parameters/filters/#boolean-operators
			 */
	...
	public function search_engine_client_add_filter_geolocation_distance( $field_name, $geo_latitude, $geo_longitude, $distance ) {
		...
		// https://www.amazon_personalize.com/doc/guides/managing-results/refine-results/geolocation/how-to/filter-results-around-a-location/
		// https://www.amazon_personalize.com/doc/api-reference/api-parameters/aroundRadius/
	 ...
	 * https://www.amazon_personalize.com/doc/api-reference/api-parameters/attributesForFaceting/
	 *
	 * @param $field_name
	 */
	...
	function search_engine_client_event_tracking_set_is_return_query_id(
		...
		// https://www.amazon_personalize.com/doc/api-reference/api-parameters/clickAnalytics/
	...
	function search_engine_client_event_tracking_set_user_is_personalization(
		...
		// https://www.amazon_personalize.com/doc/api-reference/api-parameters/enablePersonalization/
		$this->search_parameters['enablePersonalization'] = $is_personalization;

		// https://www.amazon_personalize.com/doc/api-reference/api-parameters/personalizationImpact/
		//$this->search_parameters['personalizationImpact'] = 20;

		// https://www.amazon_personalize.com/doc/api-reference/api-parameters/analyticsTags/
		//$this->search_parameters['analyticsTags'] = [
		//    'front_end',
		//    'website2'
		//  ];

		// https://www.amazon_personalize.com/doc/api-reference/api-parameters/enableReRanking/
	}
	...
	public function search_engine_client_event_tracking_set_user_token( $user_token ) {
		// https://www.amazon_personalize.com/doc/api-reference/api-parameters/userToken/
