...
WPSOLR_Extension::require_once_wpsolr_extension( WPSOLR_Extension::EXTENSION_CRON, true );
...
$is_plugin_active = WPSOLR_Extension::is_plugin_active( WPSOLR_Extension::EXTENSION_CRON );
?>
...
<form id="wpsolr_form_new_cron" method="post">
    <input type="hidden" name="wpsolr_new_cron"
        ...
        <div class='wrapper'>
            ...
            <div class="wdm_row">
                <div class='col_left'>
					...
					<?php WPSOLR_Escape::echo_escaped( WPSOLR_Help::get_help( WPSOLR_Help::HELP_ADDON_CRON ) ); ?>
                </div>
                <div class='col_right'>
            ...
            <div class="wdm_row">
                ...
                <div class='col_right'>
                    ...
                    />
                    (<?php WPSOLR_Escape::echo_esc_html( count( $crons ) ); ?> cron already)
                </div>
                <div class="clear"></div>
            </div>
			...
			<?php foreach ( $crons as $cron_uuid => $cron ) {
				...
				?>
                <div class="wpsolr_cron" data-wpsolr-cron-label="<?php WPSOLR_Escape::echo_esc_attr( $cron_label ); ?>">
                    <h4 class='head_div'><?php WPSOLR_Escape::echo_esc_html( $cron_label ); ?></h4>
                    <div class="wdm_row">
                        <div class='col_left'>
                            Cron label
                            <input type="button"
                        ...
                        <div class='col_right'>
                            <input type='text'
                                   name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[indexing][<?php WPSOLR_Escape::echo_esc_attr( $cron_uuid ); ?>][<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_CRON_INDEXING_LABEL ); ?>]'
                                   placeholder="Enter a Number"
                                   value="<?php WPSOLR_Escape::echo_esc_attr( $cron_label ); ?>">
                    ...
                    <div class="wdm_row">
                        ...
                        <div class='col_right'>
                            <input type='password' <?php WPSOLR_Escape::echo_escaped( $is_plugin_active ? '' : 'readonly' ); ?>
                                   class="wpsolr_password"
                                   name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[indexing][<?php WPSOLR_Escape::echo_esc_attr( $cron_uuid ); ?>][<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_CRON_INDEXING_PASSWORD ); ?>]'
                                   value='<?php WPSOLR_Escape::echo_esc_attr( $password ); ?>'
                    ...
                    <div class="wdm_row">
                        ...
                        <div class='col_right'>
                            ...
                            <div class="wpsolr_collapsed" style="margin:10px;">
                                <textarea rows="4"
                                          class="wpsolr-cron-command-url"><?php WPSOLR_Escape::echo_esc_textarea( $command_curl ); ?></textarea>
                            </div>
                            <!--
                            <input type="button" class="button-primary wpsolr_collapser" value="Show the wget command"/>
                            <div class="wpsolr_collapsed" style="margin:10px;">
                                <textarea rows="4"><?php WPSOLR_Escape::echo_esc_html( $command_wget ); ?></textarea>
                            </div>
                            -->
                        </div>
                        <div class="clear"></div>
                    ...
                    <div class="wdm_row">
                        ...
                        <div class='col_right'>
							<?php if ( $is_locked ) { ?>
                                <input type="button"
                                       data-wpsolr-process-id="<?php WPSOLR_Escape::echo_esc_attr( $cron_uuid ); ?>"
                                       style="float:left;"
                    ...
                    <div class="wdm_row">
                        ...
                        <div class='col_right'>
							<?php
							$option_logs_name = WPSOLR_Option_Cron::get_option_cron_log_name( $cron_uuid );
							$log              = get_option( $option_logs_name, '' );
                            ...
                            <div class="wpsolr_collapsed" style="margin:10px;">
                                <textarea
                                        ...
                                        name='<?php WPSOLR_Escape::echo_esc_attr( $option_logs_name ); ?>'
                                        rows="30"><?php WPSOLR_Escape::echo_esc_textarea( empty( $log ) ? 'No log available.' : $log ); ?>
                                </textarea>
                            </div>
                        </div>
                        <div class="clear"></div>
                ...
                <div class="submit">
					<?php if ( $license_manager->get_license_is_activated( OptionLicenses::LICENSE_PACKAGE_CRON ) ) { ?>
                        <div class="wpsolr_premium_block_class">
							<?php WPSOLR_Escape::echo_escaped( $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_CRON, OptionLicenses::TEXT_LICENSE_ACTIVATED, true, true ) ); ?>
                        </div>
                        <input
                                name="save_cron"
                                ...
                                value="Save Options"/>
					<?php } else { ?>
						<?php WPSOLR_Escape::echo_escaped( $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_CRON, 'Save Options', true, true ) ); ?>
                        <br/>
					<?php } ?>
                </div>
            </div>
