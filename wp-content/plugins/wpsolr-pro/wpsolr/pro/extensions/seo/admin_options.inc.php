...
<div class="wdm_row">
    <div class='col_left'>
        Speed up sitemaps generation
		<?php //WPSOLR_Escape::echo_esc_none( WPSOLR_Help::get_help(  WPSOLR_Help::HELP_SEO_STEALTH_MODE ) );?>
    </div>
    <div class='col_right'>
        <input type='checkbox'
               class="wpsolr_collapser"
               name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_IS_SPEED_SITEMAPS ); ?>]'
               value='1'
			<?php checked( '1', isset( $extension_options[ WPSOLR_Option::OPTION_SEO_IS_SPEED_SITEMAPS ] ) ? $extension_options[ WPSOLR_Option::OPTION_SEO_IS_SPEED_SITEMAPS ] : '?' ); ?>>

        <div class="wpsolr_collapsed">
            <p>With many post types, sitemaps can fail due to slow sql queries. This option use WPSOLR
                to boost sitemaps generation.</p>
        </div>
        <div class="clear"></div>
    </div>
</div>
...
<div class="wdm_row">
    <div class='col_left'>
        Sitemap entries per page
    </div>
    <div class='col_right'>
        <input type='text'
               name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_SITEMAP_NB_ENTRIES_PER_PAGE ); ?>]'
               placeholder="500 means each Sitemap will contain 500 links"
               value="<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Service_Container::getOption()->get_option_seo_sitemap_nb_entries_per_page( $extension_options_name ) ); ?>">
        <p>Number. Leave empty to use default value.</p>
    </div>
    <div class="clear"></div>
</div>
...
<div class="wdm_row">
    <div class='col_left'>
		...
		WPSOLR_Escape::echo_escaped( WPSOLR_Help::get_help( WPSOLR_Help::HELP_SEO_STEALTH_MODE ) ); ?>
    </div>
    <div class='col_right'>
        <input type='checkbox'
               class="wpsolr_collapser"
               name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_IS_REMOVE_TEST_MODE ); ?>]'
               value='1'
...
<div class="wdm_row">
    <div class='col_left'>
        Search page content
		<?php WPSOLR_Escape::echo_escaped( WPSOLR_Help::get_help( WPSOLR_Help::HELP_SEO_STEALTH_MODE ) ); ?>
    </div>
    <div class='col_right'>

        <h3>Robots</h3>
		<?php WPSOLR_Escape::echo_escaped( WPSOLR_Help::get_help( WPSOLR_Help::HELP_SEO_TAG_NOFOLLOW ) ); ?>
        <input class="wpsolr_collapser"
               type='checkbox'
               name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_IS_CONTENTS_NOFOLLOW ); ?>]'
               value='1'
        ...
        <div style="margin-top: 10px">
			<?php WPSOLR_Escape::echo_escaped( WPSOLR_Help::get_help( WPSOLR_Help::HELP_SEO_TAG_NOINDEX ) ); ?>
            <input class="wpsolr_collapser"
                   type='checkbox'
                   name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_IS_CONTENTS_NOINDEX ); ?>]'
                   value='1'
        ...
        <div class="wpsolr_attachment">
            <img class="wpsolr_attachment_image_preview"
                 src='<?php WPSOLR_Escape::echo_esc_url( WPSOLR_Service_Container::getOption()->get_option_seo_open_graph_image_url( $extension_options_name ) ); ?>'
                 width='50' height='50'>
            ...
            <input type='hidden'
                   ...
                   name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_OPEN_GRAPH_IMAGE ); ?>]'
                   value="<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Service_Container::getOption()->get_option_seo_open_graph_image_id( $extension_options_name ) ); ?>">
        </div>
        <br/>

        <input type='text'
               name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_TEMPLATE_META_TITLE ); ?>]'
               placeholder="<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_META_VAR_VALUE ); ?> | myblog"
               value="<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Service_Container::getOption()->get_option_seo_template_meta_title( $extension_options_name ) ); ?>">

        <p>
            Set a title template for all your search
            pages. <?php WPSOLR_Escape::echo_esc_html( WPSOLR_Option::OPTION_SEO_META_VAR_VALUE ); ?>
            willl be replaced by the search page keywords
            and filters.
        </p>

        <textarea
                name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_TEMPLATE_META_DESCRIPTION ); ?>]'
                rows="10"
                placeholder="Description of current search containing parameter <?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_META_VAR_VALUE ); ?> anywhere."
                style="width: 100%"><?php WPSOLR_Escape::echo_esc_textarea( WPSOLR_Service_Container::getOption()->get_option_seo_template_meta_description( $extension_options_name ) ); ?></textarea>
...
<div class="wdm_row">
    ...
    <div class='col_right'>
        <div style="margin-bottom: 30px">
			<?php WPSOLR_Escape::echo_escaped( WPSOLR_Help::get_help( WPSOLR_Help::HELP_SEO_PERMALINKS_REDIRECT ) ); ?>
            <input type='text'
                   name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_PERMALINKS_HOME ); ?>]'
                   placeholder=""
                   value="<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Service_Container::getOption()->get_option_seo_common_permalinks_home( $extension_options_name ) ); ?>">
            <p>
        ...
        <div style="margin-top: 10px">
            ...
            <input class="wpsolr_collapser"
                   type='checkbox'
                   name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_IS_PERMALINKS_NOFOLLOW ); ?>]'
                   value='1'
            ...
            <div style="margin-top: 10px">
                ...
                <input class="wpsolr_collapser"
                       type='checkbox'
                       name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_IS_PERMALINKS_NOINDEX ); ?>]'
                       value='1'
            ...
            <div>
                <div style="margin-bottom: 50px">
                    <input class="wpsolr_collapser"
                           type='radio'
                           name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_PERMALINKS_USAGE ); ?>]'
                           value=''
                ...
                <div style="margin-top: 10px">
                    <input class="wpsolr_collapser"
                           type='radio'
                           name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_PERMALINKS_USAGE ); ?>]'
                           value='<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_PERMALINKS_USAGE_NORMAL ); ?>'
                    ...
                    <div class="wpsolr_collapsed">
                        ...
                        <div style="margin-left: 30px;">
                            ...
                            <input class="wpsolr_collapser"
                                   type='checkbox'
                                   name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_PERMALINKS_IS_REDIRECT_FROM_SEARCH ); ?>]'
                                   value='1'
                ...
                <div style="margin-top: 10px">
                    <input class="wpsolr_collapser"
                           type='radio'
                           name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_PERMALINKS_USAGE ); ?>]'
                           value='<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_PERMALINKS_USAGE_REDIRECT_TO_SEARCH ); ?>'
            ...
            <div style="margin-bottom: 10px">
				<?php WPSOLR_Escape::echo_escaped( WPSOLR_Help::get_help( WPSOLR_Help::HELP_SEO_FACET_PERMALINKS ) ); ?>
                <input class="wpsolr_collapser"
                       type='checkbox'
                       name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_IS_GENERATE_FACETS_PERMALINKS ); ?>]'
                       value='1'
                ...
                <div class="wpsolr_collapsed">
                    <p>
                        ...
                        facets. <?php WPSOLR_Escape::echo_esc_html( wpsolr_get_menu_html( WPSOLR_ADMIN_MENU_FACETS, 'Configure each facet individually', true ) ); ?>
                        to
                        define
                    ...
                    <div style="margin-left: 30px;">
                        ...
                        <input class="wpsolr_collapser"
                               type='checkbox'
                               name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_IS_REDIRECT_FACETS_PERMALINKS_HOME ); ?>]'
                               value='1'
            ...
            <div style="margin-bottom: 10px">
				<?php WPSOLR_Escape::echo_escaped( WPSOLR_Help::get_help( WPSOLR_Help::HELP_SEO_SEARCH_KEYWORDS_PERMALINKS ) ); ?>
                <input class="wpsolr_collapser"
                       type='checkbox'
                       name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_IS_GENERATE_KEYWORDS_PERMALINKS ); ?>]'
                       value='1'
                       disabled
            ...
            <div style="margin-bottom: 30px">
				<?php WPSOLR_Escape::echo_escaped( WPSOLR_Help::get_help( WPSOLR_Help::HELP_SEO_SORT_PERMALINKS ) ); ?>
                <input class="wpsolr_collapser"
                       type='checkbox'
                       name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_IS_GENERATE_SORTS_PERMALINKS ); ?>]'
                       value='1'
                       disabled
            ...
            <div style="margin-bottom: 10px">
                <input type='radio'
                       class="wpsolr_collapser"
                       name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_PERMALINKS_STORAGE ); ?>]'
                       value='<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_PERMALINKS_STORAGE_IS_DATABASE ); ?>'
                ...
                '<?php WPSOLR_Escape::echo_esc_html( WPSOLR_Option_Seo::CONST_TABLE_NAME_SEO_PERMALINKS ); ?>'
                ...
                <div class="wpsolr_collapsed" style="margin:10px;float:right">
					...
					WPSOLR_Escape::echo_escaped( sprintf(
						...
						'',
						sprintf( "Delete the table with it's %s permalinks", WPSOLR_Escape::esc_html( $nb_stored_permalinks ) )
					) );
					?>
                </div>
            </div>
            ...
            <div style="margin-bottom: 30px">
                <input type='radio'
                       class="wpsolr_collapser"
                       name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_PERMALINKS_STORAGE ); ?>]'
                       value='<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SEO_PERMALINKS_STORAGE_IS_INDEX ); ?>'
                       disabled
                    ...
                    <select name='wdm_solr_res_data[default_solr_index_for_search]'>
						...
						foreach (
							...
							WPSOLR_Escape::echo_escaped( sprintf( "
									...
									isset( $solr_index['index_name'] ) ? WPSOLR_Escape::esc_html( $solr_index['index_name'] ) : 'Unnamed
											Solr index' )
							);
