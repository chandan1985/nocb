...
$is_group_exists            = isset( $event_tracking[ WPSOLR_Option::OPTION_SUGGESTION_MODELS ] ) && isset( $event_tracking[ WPSOLR_Option::OPTION_SUGGESTION_MODELS ][ $post_type ] );
$event_tracking_model_label = $is_group_exists && isset( $event_tracking[ WPSOLR_Option::OPTION_SUGGESTION_MODELS ][ $post_type ][ WPSOLR_Option::OPTION_SUGGESTION_MODEL_LABEL ] ) ? $event_tracking[ WPSOLR_Option::OPTION_SUGGESTION_MODELS ][ $post_type ][ WPSOLR_Option::OPTION_SUGGESTION_MODEL_LABEL ] : '';
$event_tracking_model_nb    = $is_group_exists && isset( $event_tracking[ WPSOLR_Option::OPTION_SUGGESTION_MODELS ][ $post_type ][ WPSOLR_Option::OPTION_SUGGESTION_MODEL_NB ] ) ? $event_tracking[ WPSOLR_Option::OPTION_SUGGESTION_MODELS ][ $post_type ][ WPSOLR_Option::OPTION_SUGGESTION_MODEL_NB ] : '10';
?>
    ...
    <div class="wdm_row">
        ...
        <div class='col_right'>
            <input type='checkbox'
                   ...
                   name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SUGGESTIONS_SUGGESTIONS ); ?>][<?php WPSOLR_Escape::echo_esc_attr( $event_tracking_uuid ); ?>][<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SUGGESTION_MODELS ); ?>][<?php WPSOLR_Escape::echo_esc_attr( $post_type ); ?>][<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SUGGESTION_MODEL_ID ); ?>]'
                   value='y'
				<?php
				checked( isset( $event_tracking[ WPSOLR_Option::OPTION_SUGGESTION_MODELS ][ $model_type ][ WPSOLR_Option::OPTION_SUGGESTION_MODEL_ID ] ) );
				?>
            >
            ...
            <div class="wdm_row wpsolr_collapsed  wpsolr-remove-if-hidden">
                ...
                <div class='col_right'>
                    <input class="<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SUGGESTION_MODEL_LABEL ); ?>"
                           ...
                           value="<?php WPSOLR_Escape::echo_esc_attr( $event_tracking_model_label ); ?>">
            ...
            <div class="wdm_row wpsolr_collapsed  wpsolr-remove-if-hidden">
                ...
                <div class='col_right'>
                    <input class="<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SUGGESTION_MODEL_NB ); ?>"
                           ...
                           placeholder="Enter the maximum number of event_trackings displayed in this group."
                           value="<?php WPSOLR_Escape::echo_esc_attr( $event_tracking_model_nb ); ?>">
                    Max number of <?php WPSOLR_Escape::echo_esc_html( $post_label ); ?> in event_trackings
                </div>
                <div class="clear"></div>
            </div>
                ...
                <div class="wdm_row wpsolr_collapsed  wpsolr-remove-if-hidden">
                    ...
                    <div class='col_right'>
                        <input class="<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SUGGESTION_MODEL_PRODUCT_IS_SHOW_RATING ); ?>"
                               ...
                               value='y'
							<?php
							checked( isset( $event_tracking[ WPSOLR_Option::OPTION_SUGGESTION_MODELS ][ $model_type ][ WPSOLR_Option::OPTION_SUGGESTION_MODEL_PRODUCT_IS_SHOW_RATING ] ) );
							?>
                        >
                ...
                <div class="wdm_row wpsolr_collapsed  wpsolr-remove-if-hidden">
                    ...
                    <div class='col_right'>
                        <input class="<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SUGGESTION_MODEL_PRODUCT_IS_SHOW_PRICE ); ?>"
                               ...
                               value='y'
							<?php
							checked( isset( $event_tracking[ WPSOLR_Option::OPTION_SUGGESTION_MODELS ][ $model_type ][ WPSOLR_Option::OPTION_SUGGESTION_MODEL_PRODUCT_IS_SHOW_PRICE ] ) );
							?>
                        >
                ...
                <div class="wdm_row wpsolr_collapsed  wpsolr-remove-if-hidden">
                    ...
                    <div class='col_right'>
                        <input class="<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SUGGESTION_MODEL_PRODUCT_IS_SHOW_ADD_TO_CART ); ?>"
                               ...
                               value='y'
							<?php
							checked( isset( $event_tracking[ WPSOLR_Option::OPTION_SUGGESTION_MODELS ][ $model_type ][ WPSOLR_Option::OPTION_SUGGESTION_MODEL_PRODUCT_IS_SHOW_ADD_TO_CART ] ) );
							?>
                        >
