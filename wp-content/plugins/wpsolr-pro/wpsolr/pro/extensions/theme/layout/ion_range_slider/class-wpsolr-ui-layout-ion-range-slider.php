...
class WPSOLR_UI_Layout_Ion_Range_slider extends WPSOLR_UI_Layout_Abstract {
	...
	public static function get_js_help_text() {
		...
		?>
        <p>
            <a href="<?php WPSOLR_Escape::echo_esc_url( $license_manager->add_campaign_to_url( 'https://www.wpsolr.com/guide/configuration-step-by-step-schematic/activate-extensions/extension-theme/theme-facets-layouts/theme-range-slider-layout/' ) ); ?>"
               target="__new1">See the full online documentation for Range sliders</a></p>
		<?php
		return /** @lang text */
			<<<'TAG'
			...
			<p></p>See <a href="http://ionden.com/a/plugins/ion.rangeSlider/demo.html" target="_new">all ion.rangeSlider options</a> available with official demos.</p>
			<p>Add a grid and a currency prefix:<br/><pre><code>wpsolr_ion_range_slider_options = { grid: true, prefix: "$"};</code></pre></p>
			<p>Convert date to US format:<pre><code>wpsolr_ion_range_slider_options = {
grid: true,
