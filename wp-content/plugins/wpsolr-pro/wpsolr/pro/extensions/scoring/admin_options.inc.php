...
WPSOLR_Extension::require_once_wpsolr_extension( WPSOLR_Extension::EXTENSION_SCORING, true );
...
$is_plugin_active = WPSOLR_Extension::is_plugin_active( WPSOLR_Extension::EXTENSION_SCORING );
        ...
        <div class='wrapper'>
            ...
            <div class="wdm_row">
                <div class='col_left'>
					...
					<?php WPSOLR_Escape::echo_escaped( WPSOLR_Help::get_help( WPSOLR_Help::HELP_ADDON_ADVANCED_SCORING ) ); ?>
                </div>
                <div class='col_right'>
            ...
            <div class="wdm_row">
                ...
                <div class='col_right'>
                    <input class="wpsolr_collapser"
                           type='checkbox' <?php WPSOLR_Escape::echo_escaped( $is_plugin_active ? '' : 'readonly' ); ?>
                           name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING_IS_DECAY ); ?>]'
                           value='1'
                        ...
                        <div class="wdm_row">
                            ...
                            <div class='avail_fac' style="width:100%">
                                <input type='hidden' id='select_fac'
                                       name='<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING_DECAY_FIELDS ); ?>]'
                                       value='<?php WPSOLR_Escape::echo_esc_attr( $scoring_fields_decays_str ); ?>'>
											...
											if ( ! empty( $selected_val ) ) {
                                                ...
                                                <li id='<?php WPSOLR_Escape::echo_esc_attr( $selected_val ); ?>'
                                                    ...
                                                    <div class="wdm_row">
                                                        ...
                                                        <div class='col_right'>
                                                            <select name='<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING_DECAY_FUNCTIONS ); ?>][<?php WPSOLR_Escape::echo_esc_attr( $selected_val ); ?>]'>
																<?php foreach ( WPSOLR_Option_Scoring::$DECAY_FUNCTIONS as $function_id => $function_def ) { ?>
                                                                    <option
                                                                            value="<?php WPSOLR_Escape::echo_esc_attr( $function_id ); ?>" <?php selected( $function_id, WPSOLR_Service_Container::getOption()->get_option_scoring_field_decay_function( $selected_val, WPSOLR_Option_Scoring::DECAY_FUNCTION_GAUSS ) ); ?> ><?php WPSOLR_Escape::echo_esc_html( $function_def['label'] ); ?></option>
																<?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
															...
															<?php if ( WpSolrSchema::get_custom_field_is_date_type( $selected_val ) ) { ?>
                                                                <div>
                                                                    <input class="wpsolr_collapser"
                                                                           type='radio'
                                                                           name="origin"
                                                                           id="origin_now[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING_DECAY_ORIGINS ); ?>][<?php WPSOLR_Escape::echo_esc_attr( $selected_val ); ?>]"
                                                                           value='1'
																		<?php checked( WPSOLR_Service_Container::getOption()->get_option_scoring_field_decay_origin_is_now( $selected_val ) ); ?>
                                                                    /> Now
                                                                    <p class="wpsolr_collapsed">
                                                                        <input
                                                                                type="hidden"
                                                                                name='<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING_DECAY_ORIGINS ); ?>][<?php WPSOLR_Escape::echo_esc_attr( $selected_val ); ?>]'
                                                                                style="width: 100%"
                                                                                value="<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING_DECAY_ORIGIN_DATE_NOW ); ?>"
                                                                        />
                                                                ...
                                                                <div><input class="wpsolr_collapser"
                                                                            type='radio'
                                                                            name="origin"
                                                                            id="origin_custom[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING_DECAY_ORIGINS ); ?>][<?php WPSOLR_Escape::echo_esc_attr( $selected_val ); ?>]"
                                                                            value='2'
																		<?php checked( ! WPSOLR_Service_Container::getOption()->get_option_scoring_field_decay_origin_is_now( $selected_val ) ); ?>
                                                                    /> Pick an origin
                                                                    <div class="wpsolr_collapsed"
                                                                        ...
                                                                        <input class="wpsolr-remove-if-hidden"
                                                                               type="date"
                                                                               id='origin_custom_value[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING_DECAY_ORIGINS ); ?>][<?php WPSOLR_Escape::echo_esc_attr( $selected_val ); ?>]'
                                                                               name='<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING_DECAY_ORIGINS ); ?>][<?php WPSOLR_Escape::echo_esc_attr( $selected_val ); ?>]'
                                                                               value="<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Service_Container::getOption()->get_option_scoring_field_decay_origin( $selected_val, '' ) ); ?>"
                                                                               style="width: 100%"/>
															...
															<?php if ( WpSolrSchema::get_custom_field_is_numeric_type( $selected_val ) ) { ?>
                                                                <div>
                                                                    <input
                                                                            type='text'
                                                                            name='<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING_DECAY_ORIGINS ); ?>][<?php WPSOLR_Escape::echo_esc_attr( $selected_val ); ?>]'
                                                                            value='<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Service_Container::getOption()->get_option_scoring_field_decay_origin( $selected_val, WPSOLR_Option::OPTION_SCORING_DECAY_ORIGIN_ZERO ) ); ?>'
                                                                    />
                                                    ...
                                                    <div class="wdm_row" style="top-margin:5px">
                                                        ...
                                                        <div class='col_right'>
                                                            <input type='input'
                                                                   placeholder="<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING_DECAY_OFFSET_DEFAULT ); ?>"
                                                                   class='wpsolr_field_boost_factor_class'
                                                                   name='<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING_DECAY_OFFSETS ); ?>][<?php WPSOLR_Escape::echo_esc_attr( $selected_val ); ?>]'
                                                                   value='<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Service_Container::getOption()->get_option_scoring_field_decay_offset( $selected_val ) ); ?>'
                                                            />
                                                            <p>
                                                    ...
                                                    <div class="wdm_row" style="top-margin:5px">
                                                        ...
                                                        <div class='col_right'>
                                                            <input type='input'
                                                                   placeholder="<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING_DECAY_SCALE_DEFAULT ); ?>"
                                                                   class='wpsolr_field_boost_factor_class'
                                                                   name='<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING_DECAY_SCALES ); ?>][<?php WPSOLR_Escape::echo_esc_attr( $selected_val ); ?>]'
                                                                   value='<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Service_Container::getOption()->get_option_scoring_field_decay_scale( $selected_val ) ); ?>'
                                                            />
                                                            <p>
                                                    ...
                                                    <div class="wdm_row" style="top-margin:5px">
                                                        ...
                                                        <div class='col_right'>
                                                            <input type='input'
                                                                   placeholder="<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING_DECAY_VALUES_DEFAULT ); ?>"
                                                                   class='wpsolr_field_boost_factor_class'
                                                                   name='<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_SCORING_DECAY_VALUES ); ?>][<?php WPSOLR_Escape::echo_esc_attr( $selected_val ); ?>]'
                                                                   value='<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Service_Container::getOption()->get_option_scoring_field_decay_value( $selected_val ) ); ?>'
                                                            />
                                                            <p>
										...
										if ( $built_fac != '' ) {
											...
											if ( ! in_array( $buil_fac, $scoring_fields_decays ) ) {
												...
												WPSOLR_Escape::echo_escaped( sprintf(
														"<li id='%s' class='ui-state-default facets'>%s
                ...
                <div class="submit">
					<?php if ( $license_manager->get_license_is_activated( OptionLicenses::LICENSE_PACKAGE_SCORING ) ) { ?>
                        <div class="wpsolr_premium_block_class">
							<?php WPSOLR_Escape::echo_escaped( $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_SCORING, OptionLicenses::TEXT_LICENSE_ACTIVATED, true, true ) ); ?>
                        </div>
                        <input
                                name="save_scoring"
                                ...
                                value="Save Options"/>
					<?php } else { ?>
						<?php WPSOLR_Escape::echo_escaped( $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_SCORING, 'Save Options', true, true ) ); ?>
                        <br/>
					<?php } ?>
                </div>
            </div>
