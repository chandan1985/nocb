 ...
 */
class WPSOLR_Plugin_Wpml extends WPSOLR_Extension {
	...
	function __construct() {
		...
		add_action( WPSOLR_Events::WPSOLR_ACTION_SET_CURRENT_LANGUAGE, [
			$this,
	...
	function wpsolr_filter_javascript_front_localized_parameters(
		...
		$parameters['data']['lang'] = $sitepress->get_current_language();
