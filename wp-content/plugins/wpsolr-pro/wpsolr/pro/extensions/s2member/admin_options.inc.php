...
WPSOLR_Extension::require_once_wpsolr_extension( WPSOLR_Extension::EXTENSION_S2MEMBER, true );


WPSOLR_Plugin_S2Member::update_custom_field_capabilities( WPSOLR_Extension::EXTENSION_S2MEMBER, WPSOLR_Plugin_S2Member::CUSTOM_FIELD_NAME_STORING_POST_CAPABILITIES );
...
$is_plugin_active                    = WPSOLR_Extension::is_plugin_active( WPSOLR_Extension::EXTENSION_S2MEMBER );
            ...
            <div class="wdm_row">
                ...
                <div class='col_right'>
												<textarea id='message_user_without_capabilities_shown_no_results'
                                                          ...
                                                          rows="4" cols="100"
                                                          placeholder="<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Plugin_S2Member::DEFAULT_MESSAGE_NOT_AUTHORIZED ); ?>"><?php WPSOLR_Escape::echo_esc_textarea( empty( $extension_options['message_user_without_capabilities_shown_no_results'] ) ? trim( WPSOLR_Plugin_S2Member::DEFAULT_MESSAGE_NOT_AUTHORIZED ) : $extension_options['message_user_without_capabilities_shown_no_results'] ); ?></textarea>
                ...
                <div class="submit">
					<?php if ( ! $license_manager->is_installed || $license_manager->get_license_is_activated( OptionLicenses::LICENSE_PACKAGE_S2MEMBER ) ) { ?>
                        <div class="wpsolr_premium_block_class">
							<?php WPSOLR_Escape::echo_escaped( $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_S2MEMBER, OptionLicenses::TEXT_LICENSE_ACTIVATED, true ) ); ?>
                        </div>
                        <input
                                ...
                                value="Save Options"/>
					<?php } else { ?>
						<?php WPSOLR_Escape::echo_escaped( $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_S2MEMBER, 'Save Options', true ) ); ?>
                        <br/>
					<?php } ?>
                </div>
            </div>
