...
WPSOLR_Extension::require_once_wpsolr_extension( WPSOLR_Extension::EXTENSION_GROUPS, true );

WPSOLR_Plugin_Groups::update_custom_field_capabilities( WPSOLR_Extension::EXTENSION_GROUPS, WPSOLR_Plugin_Groups::CUSTOM_FIELD_NAME_STORING_POST_CAPABILITIES );

$extension_options                   = WPSOLR_Service_Container::getOption()->get_option_groups();
$is_plugin_active                    = WPSOLR_Extension::is_plugin_active( WPSOLR_Extension::EXTENSION_GROUPS );
        ...
        <div class='wrapper'>
            ...
            <div class="wdm_note">
				...
				<?php if ( ( ! $is_plugin_custom_field_for_indexing ) && ( isset( $extension_options['is_extension_active'] ) ) ): ?>
                    <p>
                        The custom field <b>'<?php WPSOLR_Escape::echo_esc_html( $custom_field_for_indexing_name ); ?>
                            '</b>
                        is not selected,
                        ...
                        <b>'<?php WPSOLR_Escape::echo_esc_html( $custom_field_for_indexing_name ); ?>'</b>.
            ...
            <div class="wdm_row">
                ...
                <div class='col_right'>
												<textarea id='message_user_without_groups_shown_no_results'
                                                          ...
                                                          rows="4" cols="100"
                                                          placeholder="<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Plugin_Groups::DEFAULT_MESSAGE_NOT_AUTHORIZED ); ?>"><?php WPSOLR_Escape::echo_esc_textarea( empty( $extension_options['message_user_without_groups_shown_no_results'] ) ? trim( WPSOLR_Plugin_Groups::DEFAULT_MESSAGE_NOT_AUTHORIZED ) : $extension_options['message_user_without_groups_shown_no_results'] ); ?></textarea>
            ...
            <div class="wdm_row">
                ...
                <div class='col_right'>
                    <input type='text' id='message_result_capability_matches_user_group'
                           ...
                           value="<?php WPSOLR_Escape::echo_esc_attr( empty( $extension_options['message_result_capability_matches_user_group'] ) ? 'Private content : %1' : $extension_options['message_result_capability_matches_user_group'] ); ?>"><span
                ...
                <div class="submit">
					<?php if ( ! $license_manager->is_installed || $license_manager->get_license_is_activated( OptionLicenses::LICENSE_PACKAGE_GROUPS ) ) { ?>
                        <div class="wpsolr_premium_block_class">
							<?php WPSOLR_Escape::echo_escaped( $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_GROUPS, OptionLicenses::TEXT_LICENSE_ACTIVATED, true ) ); ?>
                        </div>
                        <input
                                ...
                                value="Save Options"/>
					<?php } else { ?>
						<?php WPSOLR_Escape::echo_escaped( $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_GROUPS, 'Save Options', true ) ); ?>
                        <br/>
					<?php } ?>
                </div>
            </div>
