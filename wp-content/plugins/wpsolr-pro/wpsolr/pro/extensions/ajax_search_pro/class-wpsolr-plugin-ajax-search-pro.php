...
namespace wpsolr\pro\extensions\ajax_search_pro;
...
/**
 * Class WPSOLR_Plugin_Ajax_Search_Pro
 * @package wpsolr\core\classes\extensions\ajax_search_pro
 */
class WPSOLR_Plugin_Ajax_Search_Pro extends WPSOLR_Extension {
	...
	public function wpsolr_action_query( $parameters ) {
		...
		if ( ! empty( $wpsolr_query->query['post_type'] ) ) {
			...
			$search_engine_client->search_engine_client_add_filter_term( sprintf( 'WPSOLR_Plugin_Ajax_Search_Pro type:%s', $wpsolr_query->query['post_type'] ), WpSolrSchema::_FIELD_NAME_TYPE, false, $wpsolr_query->query['post_type'] );
		}
