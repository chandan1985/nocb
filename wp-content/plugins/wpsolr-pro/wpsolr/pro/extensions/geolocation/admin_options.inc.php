...
WPSOLR_Extension::require_once_wpsolr_extension( WPSOLR_Extension::EXTENSION_GEOLOCATION, true );
...
$is_plugin_active = WPSOLR_Extension::is_plugin_active( WPSOLR_Extension::EXTENSION_GEOLOCATION );
        ...
        <div class='wrapper'>
            ...
            <div class="wdm_row">
                <div class='col_left'>
					...
					<?php WPSOLR_Escape::echo_escaped( WPSOLR_Help::get_help( WPSOLR_Help::HELP_ADDON_GEOLOCATION ) ); ?>
                </div>
                <div class='col_right'>
            ...
            <div class="wdm_row">
                ...
                <div class='col_right'>
                    <select
                            name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_GEOLOCATION_DEFAULT_SORT ); ?>]'>
						<?php
            ...
            <div class="wdm_row">
                ...
                <div class='col_right'>
                    <input type='text'
                           name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_GEOLOCATION_RESULT_DISTANCE_LABEL ); ?>]'
                           placeholder="%1$s: %2$s"
            ...
            <div class="wdm_row">
                ...
                <div class='col_right'>
                    <input type='text'
                           name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_GEOLOCATION_JQUERY_SELECTOR ); ?>]'
            ...
            <div class="wdm_row">
                ...
                <div class='col_right'>
                    <input type='checkbox'
                           name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_GEOLOCATION_IS_SHOW_USER_AGREEMENT_AJAX ); ?>]'
                           value='1'
                    ...
                    <input type='checkbox'
                           name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_GEOLOCATION_IS_SHOW_USER_AGREEMENT_AJAX_IS_DEFAULT_YES ); ?>]'
                           value='1'
                    ...
                    <input type='text'
                           name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_GEOLOCATION_USER_AGREEMENT_LABEL ); ?>]'
                           placeholder="<?php WPSOLR_Escape::echo_esc_attr( OptionLocalization::get_term( OptionLocalization::get_options(), 'geolocation_ask_user' ) ); ?>"
                           value="<?php WPSOLR_Escape::echo_esc_attr( ( ! empty( $options[ WPSOLR_Option::OPTION_GEOLOCATION_USER_AGREEMENT_LABEL ] ) ? $options[ WPSOLR_Option::OPTION_GEOLOCATION_USER_AGREEMENT_LABEL ] : '' ) ); ?>">
            ...
            <div class="wdm_row">
                ...
                <div class='col_right'>
                    <input type='checkbox'
                           name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_GEOLOCATION_IS_FILTER_EMPTY_COORDINATES ); ?>]'
                           value='1'
                ...
                <div class="submit">
					<?php if ( $license_manager->get_license_is_activated( OptionLicenses::LICENSE_PACKAGE_GEOLOCATION ) ) { ?>
                        <div class="wpsolr_premium_block_class">
							<?php WPSOLR_Escape::echo_escaped( $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_GEOLOCATION, OptionLicenses::TEXT_LICENSE_ACTIVATED, true, true ) ); ?>
                        </div>
                        <input
                                ...
                                value="Save Options"/>
					<?php } else { ?>
						<?php WPSOLR_Escape::echo_escaped( $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_GEOLOCATION, 'Save Options', true, true ) ); ?>
                        <br/>
					<?php } ?>
                </div>
            </div>
