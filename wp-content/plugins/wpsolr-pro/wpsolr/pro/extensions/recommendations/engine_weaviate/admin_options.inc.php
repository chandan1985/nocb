...
$application_id = $current_index[ WPSOLR_Hosting_Api_Abstract::FIELD_NAME_FIELDS_INDEX_KEY ];
?>
...
<div class="wdm_row">
    ...
    <div class='col_right'>
        ...
        <p>Create and train a model in your
            <a href="<?php WPSOLR_Escape::echo_esc_url( sprintf( 'https://www.algolia.com/apps/%s/recommend/models', $application_id ) ); ?>"
               target="_algolia_dashboard">Algolia's dashboard</a> on
            index "<?php WPSOLR_Escape::echo_esc_html( $index_label ); ?>", then select the model here.
        </p>
    </div>
    <div class="clear"></div>
</div>
