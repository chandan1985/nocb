...
<div class="wdm_row">
    ...
    <div class='col_right'>
        ...
        <ol>
            <li>
                <a href="<?php /** @var WPSOLR_Hosting_Api_Amazon_Personalize $index_hosting_api */
				WPSOLR_Escape::echo_esc_url( $index_hosting_api->get_account_dashboard_url( $current_index, 'solutions' ) ); ?>"
                   target="_amazon_personalize_dashboard">Create and train a solution </a>
                using
                <a href="https://docs.aws.amazon.com/personalize/latest/dg/working-with-predefined-recipes.html"
                   target="_amazon_personalize_docs">a recipe</a>
                in your Amazon Personalize's account for
                dataset group "<?php WPSOLR_Escape::echo_esc_html( $index_label ); ?>
            </li>
            <li>
                <a href="<?php WPSOLR_Escape::echo_esc_url( $index_hosting_api->get_account_dashboard_url( $current_index, 'campaigns' ) ); ?>"
                   target="_amazon_personalize_dashboard">Create a campaign on the solution</a>
            </li>
            <li>
                Select the campaign in the list
            </li>
        </ol>
        </p>
    </div>
