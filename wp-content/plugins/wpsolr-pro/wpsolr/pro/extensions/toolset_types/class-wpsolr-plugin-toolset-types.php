...
namespace wpsolr\pro\extensions\toolset_types;
...
class WPSOLR_Plugin_Toolset_Types extends WPSOLR_Extension {
	 ...
	 * Factory
	 *
	 * @return WPSOLR_Plugin_Toolset_Types
	 */
	...
	function __construct() {
		...
		$this->_options = self::get_option_data( self::EXTENSION_TOOLSET_TYPES );
