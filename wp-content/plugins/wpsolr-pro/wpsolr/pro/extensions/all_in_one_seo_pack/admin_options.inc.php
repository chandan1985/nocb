...
WPSOLR_Extension::require_once_wpsolr_extension( WPSOLR_Extension::EXTENSION_ALL_IN_ONE_SEO, true );
...
$is_plugin_active = WPSOLR_Extension::is_plugin_active( WPSOLR_Extension::EXTENSION_ALL_IN_ONE_SEO );
        ...
        <div class='wrapper'>
            ...
            <div class="wdm_row">
                <div class='col_left'>
					...
					<?php WPSOLR_Escape::echo_escaped( WPSOLR_Help::get_help( WPSOLR_Help::HELP_ALL_IN_ONE_SEO_PACK ) ); ?>
                </div>
                <div class='col_right'>
                ...
                <div class="submit">
					<?php if ( $license_manager->get_license_is_activated( OptionLicenses::LICENSE_PACKAGE_ALL_IN_ONE_SEO_PACK ) ) { ?>
                        <div class="wpsolr_premium_block_class">
							<?php WPSOLR_Escape::echo_escaped( $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_ALL_IN_ONE_SEO_PACK, OptionLicenses::TEXT_LICENSE_ACTIVATED, true, true ) ); ?>
                        </div>
                        <input
                                ...
                                value="Save Options"/>
					<?php } else { ?>
						<?php WPSOLR_Escape::echo_escaped( $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_ALL_IN_ONE_SEO_PACK, 'Save Options', true, true ) ); ?>
                        <br/>
					<?php } ?>
                </div>
            </div>
