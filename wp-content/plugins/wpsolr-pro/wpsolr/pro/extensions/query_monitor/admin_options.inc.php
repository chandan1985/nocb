...
WPSOLR_Extension::require_once_wpsolr_extension( WPSOLR_Extension::EXTENSION_QUERY_MONITOR, true );

$extension_options_name = WPSOLR_Option::OPTION_EXTENSION_QUERY_MONITOR;

$extension_options = WPSOLR_Service_Container::getOption()->get_option_query_monitor();
$is_plugin_active  = WPSOLR_Extension::is_plugin_active( WPSOLR_Extension::EXTENSION_QUERY_MONITOR );

$plugin_name    = "Query Monitor";
$plugin_link    = "https://fr.wordpress.org/plugins/query-monitor/";
...
<div wdm-vertical-tabs-contentid="extension_groups-options" class="wdm-vertical-tabs-content wpsolr-col-9">
    <form action="options.php" method="POST" id='extension_settings_form'>
		<?php
		settings_fields( 'extension_query_monitor_opt' );
		?>
        ...
        <div class='wrapper'>
            ...
            <div class="wdm_row">
                <div class='col_left'>Use the <a
                        ...
                        plugin</a>
					<?php WPSOLR_Escape::echo_escaped( WPSOLR_Help::get_help( WPSOLR_Help::HELP_ADDON_QUERY_MONITOR ) ); ?>
                </div>
                <div class='col_right'>
            ...
            <div class='wdm_row'>
                <div class="submit">
					<?php if ( ! $license_manager->is_installed || $license_manager->get_license_is_activated( OptionLicenses::LICENSE_PACKAGE_EXTENSION_QUERY_MONITOR ) ) { ?>
                        <div class="wpsolr_premium_block_class">
							<?php WPSOLR_Escape::echo_escaped( $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_EXTENSION_QUERY_MONITOR, OptionLicenses::TEXT_LICENSE_ACTIVATED, true ) ); ?>
                        </div>
                        <input
                                ...
                                value="Save Options"/>
					<?php } else { ?>
						<?php WPSOLR_Escape::echo_escaped( $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_EXTENSION_QUERY_MONITOR, 'Save Options', true ) ); ?>
                        <br/>
					<?php } ?>
                </div>
            </div>
