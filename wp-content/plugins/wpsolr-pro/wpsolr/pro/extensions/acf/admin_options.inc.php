...
WPSOLR_Extension::require_once_wpsolr_extension( WPSOLR_Extension::EXTENSION_ACF, true );
...
$is_plugin_active  = WPSOLR_Extension::is_plugin_active( WPSOLR_Extension::EXTENSION_ACF );
...
<div wdm-vertical-tabs-contentid="extension_groups-options" class="wdm-vertical-tabs-content wpsolr-col-9">
    <form action="options.php" method="POST" id='extension_groups_settings_form'>
        ...
        <div class='wrapper'>
            ...
            <div class="wdm_row">
                <div class='col_left'>
					<?php WPSOLR_Escape::echo_escaped( WPSOLR_Help::get_help( WPSOLR_Help::HELP_ACF_REPEATERS_AND_FLEXIBLE_CONTENT_LAYOUTS ) ); ?>
            ...
            <div class="wdm_row">
                ...
                <div class='col_right'>
                    <input type='checkbox'
                           name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[display_acf_label_on_facet]'
            ...
            <div class="wdm_row">
                ...
                <div class='col_right'>
                    <input type='checkbox'
                           ...
                           name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_PLUGIN_ACF_IS_INDEX_ALL_FILES ); ?>]'
                           value='<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_PLUGIN_ACF_IS_INDEX_ALL_FILES ); ?>'
            ...
            <div class="wdm_row">
                <div class='col_left'>
					<?php WPSOLR_Escape::echo_escaped( WPSOLR_Help::get_help( WPSOLR_Help::HELP_ACF_GOOGLE_MAP ) ); ?>
                    Your Google Map API key, to use ACF Google Map fields with our Geolocation Pack
                </div>
                <div class='col_right'>
                    <input type='text'
                           name='<?php WPSOLR_Escape::echo_esc_attr( $extension_options_name ); ?>[<?php WPSOLR_Escape::echo_esc_attr( WPSOLR_Option::OPTION_PLUGIN_ACF_GOOGLE_MAP_API_KEY ); ?>]'
                           placeholder="Enter your Google Map API key ..."
                           value="<?php WPSOLR_Escape::echo_esc_attr( empty( $extension_options[ WPSOLR_Option::OPTION_PLUGIN_ACF_GOOGLE_MAP_API_KEY ] ) ? '' : $extension_options[ WPSOLR_Option::OPTION_PLUGIN_ACF_GOOGLE_MAP_API_KEY ] ); ?>"><span
                ...
                <div class="submit">
					<?php if ( ! $license_manager->is_installed || $license_manager->get_license_is_activated( OptionLicenses::LICENSE_PACKAGE_ACF ) ) { ?>
                        <div class="wpsolr_premium_block_class">
							<?php WPSOLR_Escape::echo_escaped( $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_ACF, OptionLicenses::TEXT_LICENSE_ACTIVATED, true ) ); ?>
                        </div>
                        <input
                                ...
                                value="Save Options"/>
					<?php } else { ?>
						<?php WPSOLR_Escape::echo_escaped( $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_ACF, 'Save Options', true ) ); ?>
                        <br/>
					<?php } ?>
                </div>
            </div>
