...
.page-template-template-subscr-psa .logo{margin-left: 40px;}
...
<div class="content-wrap" style="font-family:'Roboto', 'Arial', sans-serif; color:#ffffff; background: linear-gradient(to bottom left , #000010 10%, #205492 80%);">
	<div class="subscribe_wraper">
		<div class="subscribe_top">
			<div class="subscribe-top-heading-text" style="padding: 32px 10% 0px 10%; margin: 0px;">
			...
			<div class="subscribe-bottom-heading-text" style="padding: 0 10% 0px 10%; margin: 0px;">
		...
		<div id="subscribe_plans_box" class="subscribe_plans_box" style="padding-left: 10%; padding-top: 3%; padding-bottom: 16px; padding-right: 5px">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="btm-logo">
	  			<tbody>
					<tr>
						<td></td>
			  			<td width="25%">
				  			<img class="logo-img" src="https://bridgetowermedia.com/files/2018/11/BTM-stacked-white-e1577972932931.png" style="padding: 20px; margin-top: 10%; width: 50%; float: right;" alt="BridgeTower Media">
				 		</td>
					</tr>
				</tbody>
			</table>	
