...
if( !function_exists( 'slidedeck2_get_renewal_url' ) ) {
    function slidedeck2_get_renewal_url() {
        $tier = get_option('slidedeck2_cached_tier');
        $renewal_url = SLIDEDECK2_RENEWAL_URL;
        switch($tier) {
            case 10 : // SlideDeck3 Personal Renewal
                $renewal_url .= '&add-to-cart=13649';
                break;
            case 20 : // SlideDeck3 Professional Renewal
                $renewal_url .= '&add-to-cart=13651';
                break;
            case 30 : // SlideDeck3 Developer Renewal
                $renewal_url .= '&add-to-cart=13652';
                break;
            default : 
                $renewal_url .= '&add-to-cart=13649';
        }
        
        return $renewal_url . '&renewal_keyhash=' . md5( slidedeck2_get_license_key() );
    }
}
