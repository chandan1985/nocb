(function($){
    window.PostsSource = {
        ...
        initialize: function(){
            ...
            this.elems.leftSide = $('.slidedeck-content-source.source-woocommerce #content-source-posts .left');//testing
            this.elems.rightSide = $('.slidedeck-content-source.source-woocommerce #content-source-posts .right');
