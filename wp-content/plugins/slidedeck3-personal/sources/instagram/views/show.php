        ...
        <ul class="content-source-fields">
            ...
            <li>
				<?php 
					...
					$tooltip .= '<br />';
				/*	$tooltip .= sprintf( __( 'Click %1$shere%2$s to get your token. (You only need to do this once)', $namespace ), "<a href='https://instagram.com/oauth/authorize/?client_id=e0cda3c941fc4528aa79064aa335ba71&redirect_uri=https://www.slidedeck.com?autofill_url=" .  WP_PLUGIN_URL  . "/&response_type=code' target='_blank'>", '</a>' )
				*/?>
