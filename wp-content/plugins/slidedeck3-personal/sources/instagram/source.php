...
class SlideDeckSource_Instagram extends SlideDeck {
    ...
    function add_hooks() {
	  ...
	  add_action( "wp_ajax_slidedeck_save_instagram_code", array( &$this, 'ajax_save_instagram_code' ) );
    }
     ...
     */
function ajax_save_instagram_code()
{
	
		$token = $_POST['access_token'];
		
		$output['redirect_uri'] = admin_url('admin.php?page=slidedeck2.php/options');

		
        update_option('slidedeck_last_saved_instagram_access_token', $token  );
