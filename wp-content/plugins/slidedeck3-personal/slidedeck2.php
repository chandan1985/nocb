<?php
/*
 Plugin Name: SlideDeck 3 Personal
...
class SlideDeckPlugin {
    ...
    function admin_options_update( ) {
        ...
        update_option( $this->namespace . '_last_saved_instagram_access_token', slidedeck2_sanitize( $_POST['last_saved_instagram_access_token'] ) );
                update_option( $this->namespace . '_instagram_client_id', slidedeck2_sanitize( $_POST['instagram_client_id'] ) );
    ...
    update_option( $this->namespace . '_last_saved_dribbble_api_key', slidedeck2_sanitize( $_POST['last_saved_dribbble_api_key'] ) );
    if(class_exists( 'SlideDeckPluginProfessional')){
        
        update_option( $this->namespace . '_last_saved_tumblr_api_key', slidedeck2_sanitize( $_POST['last_saved_tumblr_api_key'] ) );
    }
    ...
    */
    ...
    function ajax_verify_license_key( ) {
         wp_die( __( "Request Bypass!", $this->namespace ) );
  ...
  $current_user = wp_get_current_user();
    ...
    function slidedeck_admin_rate_us($footer_text) {
        ...
        if($screen->parent_base === 'slidedeck2') {
            
        $rate_text = sprintf(
            /* translators: %s: Link to 5 star rating */
            __( 'If you like <strong>SlideDeck 3</strong> please leave us a %s rating. It takes a minute and helps a lot. Thanks in advance!', 'give' ),
    ...
    function wp_register_scripts( ) {
        ...
        wp_register_script( "{$this->namespace}-library-js", SLIDEDECK2_URLPATH . '/js/slidedeck.jquery' . (SLIDEDECK2_ENVIRONMENT == 'development' ? '.dev' : '') . '.js', array( 'jquery' ), '1.4.1', true );
        // Public Javascript
        ...
        wp_register_script( "{$this->namespace}-preview", SLIDEDECK2_URLPATH . '/js/slidedeck-preview' . (SLIDEDECK2_ENVIRONMENT == 'development' ? '.dev' : '') . '.js', array( 'jquery',"{$this->namespace}-library-js" ), SLIDEDECK2_VERSION, true );
