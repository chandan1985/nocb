                ...
                <formset>
                    <div class="inner">
                        ...
                        <ul>
                            ...
                            <li>
				 	<?php slidedeck2_html_input( 'instagram_client_id', $instagram_client_id, array( 'type' => 'text', 'attr' => array( 'class' => 'fancy' ), 'label' => "Instagram Client Id" ) ); ?>
...
<br>
 <a href='https://api.instagram.com/oauth/authorize/?client_id=<?php echo $instagram_client_id;?>&redirect_uri=<?php echo admin_url('admin.php?page=slidedeck2.php/options');; ?>&response_type=token' class="button instabutton" ><?php _e('Generate Instagram Access Token','ds') ?></a></span></li>				
	    		    ...
	    		    <li>
                            	<?php slidedeck2_html_input( 'last_saved_dribbble_api_key', $last_saved_dribbble_api_key, array( 'type' => 'password', 'attr' => array( 'class' => 'fancy' ), 'label' => "Last used Dribbble OAuth Key" ) ); ?>
                            </li>
			 <?php if(class_exists( 'SlideDeckPluginProfessional')){ ?>
				<li>
                            	<?php slidedeck2_html_input( 'last_saved_tumblr_api_key', $last_saved_tumblr_api_key, array( 'type' => 'password', 'attr' => array( 'class' => 'fancy' ), 'label' => "Last used tumblr OAuth Consumer Key" ) ); ?>
                            </li>	
			 <?php } ?>
                            <li>
