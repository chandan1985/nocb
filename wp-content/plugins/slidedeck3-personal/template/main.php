...
{	
	...
	$string = file_get_contents(SLIDEDECK2_DIRNAME  ."/template/".$template."/slidedeck-".$template.".json");
                    ...
                    if ( isset( $slide['_image_attachment_url'] ) && !empty( $slide['_image_attachment_url'] ) ) {
                       // $image = wp_get_attachment_image_src( $slide['slide_meta']['_image_attachment'] );
                        ...
                        if (!$image) {
                           ...
                           $attachemt_id = import_remote_image(SLIDEDECK2_URL  ."template/".$template."/img/".basename($slide['_image_attachment_url']), $slide_id );
