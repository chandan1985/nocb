...
(function($){
    window.SlideDeck = function(el,opts){
		...
		var slidedeckAdjustImage = function( slide ){
            ...
            if( !$( slide ).closest(".lens-prime").length && !$( slide ).closest(".lens-parfocal").length && !$( slide ).closest(".lens-parallax").length && !$( slide ).closest(".lens-tiled").length && !$( slide ).closest(".lens-layerpro").length) {
...
if(jQuery(".slidedeck-frame.lens-classic > .slidedeck > dt").hasClass("sd2-spinePosition-horizontal")){
	...
	jQuery(".slidedeck-frame.lens-classic > .slidedeck > dd").css("left",0+"px");
            ...
            $(document).bind('keydown', function(event){
                if( !$( self.deck ).closest(".lens-prime").length && !$( self.deck ).closest(".lens-parfocal").length && ! $( self.deck ).closest(".lens-parallax").length && ! $( self.deck ).closest(".lens-tiled").length && ! $( self.deck ).closest(".lens-layerpro").length) {
