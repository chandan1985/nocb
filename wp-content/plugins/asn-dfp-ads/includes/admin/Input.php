		...
		<tr>
			...
			<td align="left">
				...
				switch( $this->type ) :
					...
					case 'radio' :
						?>
						<input type="<?php echo $this->type; ?>" name="<?php echo $this->name; ?>" id="<?php echo $this->id; ?>" <?php checked( $this->value, 1 ); ?>  value="1" /> <label for="dfp_out_of_page" class="dfp-row-title">Yes</label>
						<input type="<?php echo $this->type; ?>" name="<?php echo $this->name; ?>" id="<?php echo $this->id; ?>" <?php echo (!$this->value)?'checked':''; ?> value="0" /> <label for="dfp_out_of_page" class="dfp-row-title">No</label>
						<?php
						break;
