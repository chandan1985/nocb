 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Asentech DFP - DoubleClick Ad Manager
...
//$dfp_ads->set_asynchronous_loading( dfp_get_settings_value( 'dfp_category_remove_homepage' ) );
/*
...
if ( is_admin() ) {
    ...
    $fields['dfp_category_remove_homepage'] = array(
			'id'          => 'dfp_category_remove_homepage',
			'field'       => 'yes_no_dropdown',
			'callback'    => 'yes_no_dropdown',
      'title'       => 'Removed category for Homepage',      
			'section'     => 'general_settings',
			'description' => '<em>Removed category value for homepage.</em>'
		);
		
		/* code for remove ads for login page */
		
		$fields['dfp_remove_loginpage'] = array(
			'id'          => 'dfp_remove_loginpage',
			'field'       => 'yes_no_dropdown',
			'callback'    => 'yes_no_dropdown',
      'title'       => 'Removed Ads for Loginpage',      
			'section'     => 'general_settings',
			'description' => '<em>Removed Ads for loginpage.</em>'
		); 
