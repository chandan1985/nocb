<?php
    // Issues mobile pagination section.....
    add_action('wp_ajax_ajax_issue_Mobile', 'load_more_issue_in_mobile');
    add_action( 'wp_ajax_nopriv_ajax_issue_Mobile', 'load_more_issue_in_mobile' );

    function load_more_issues_in_mobile() {
        
        $actual_link = $_SERVER['HTTP_REFERER'];
        $actual_link = array_filter(explode('/', $actual_link));
        $term_slug = end($actual_link);
        // print_r ($term_slug);
        $term = get_term_by('slug', $term_slug, 'issues');
