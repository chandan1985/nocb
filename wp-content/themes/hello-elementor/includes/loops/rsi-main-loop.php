...
<?php if (!in_array($currpostid, $do_not_duplicate, true)) {?>
	<div class="landing-substory dir-list bor-defaultcat bor-recipe clearfix">        
        ...
        <p>&nbsp;</p>
        <p class="landing-sub-summary dir-details"><?php $excerpt = get_the_excerpt(); echo $excerpt.' '; ?><a class="read-more-link read-more-link-prod rsi-read-more-link" href="<?php the_permalink(); ?>"> View&nbsp;Report&nbsp;&rarr;</a></p>
