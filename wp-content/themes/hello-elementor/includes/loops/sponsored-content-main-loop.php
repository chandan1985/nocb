...
<?php if (!in_array($currpostid, $do_not_duplicate, true)) {?>
	<div class="landing-substory dir-list bor-defaultcat bor-recipe clearfix">        
		...
		<?php $sponsoradvertiser = get_post_meta($post->ID, 'sc_advertiser', true); ?>
        <p>&nbsp;</p>
        <p class="landing-sub-summary dir-details">Sponsored Content <strong><?php echo $sponsoradvertiser; ?></strong></p>
        <p>&nbsp;</p>
        <p class="landing-sub-summary dir-details"><?php $excerpt = get_the_excerpt(); echo $excerpt; ?><a class="read-more-link read-more-link-prod" href="<?php the_permalink(); ?>"> View&nbsp;Product&nbsp;&rarr;</a></p>
