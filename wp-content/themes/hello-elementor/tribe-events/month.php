          ...
          <!-- needs to add container here -->
            ...
            <?php } ?>
                  ...
                  <div class="event-item__content">
                    ...
                    <?php
                    if($start_month == $end_month && $start_date == $end_date && $start_year == $end_year){
                      ?>
                        <div class="event-item__date">
                          <span class="date__month"><?php echo $start_month ?></span>
                          <span class="date__day"><?php echo " " . $start_date ?></span>
