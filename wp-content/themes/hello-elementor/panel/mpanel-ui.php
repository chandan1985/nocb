					...
					tie_options(
						array( 	"name" => "Time format for blog posts",
								...
								"options" => array( "traditional"=>"Traditional" ,
													...
													"none"=>"Disable all " )));
					tie_options(
						array( 	"name" => "Show Time with date",
								"id" => "show_time",
								"type" => "checkbox"));
				?>
			</div>
				...
				<?php
					...
					tie_options(
						array(	"name" => "Logo Margin Top",
								...
								"min" => 0 ));
			tie_options(
				array( 	"name" => "Blog URL as logo link",
						"id" => "masthead_url",
						"help" => "Use subblog URL rather than site URL.",
						"type" => "checkbox"));
				?>
					...
					<div class="option-item" id="breaking_cat-item">
						<span class="label">Breaking News Categories</span>
							...
							<?php foreach ($categories as $key => $option) { ?>
								<option value="<?php echo $key ?>" <?php if (is_array($breaking_cat) && in_array( $key ,  $breaking_cat) ) { echo ' selected="selected"' ; } ?>><?php echo $option; ?></option>
							<?php } ?>
						</select>
					</div>
						...
						<?php
							...
							if($cats){
								...
								<?php 
									...
									<label for="tie_home_cats1[<?php echo $i ?>][openx]"><span>Openx Ad ID :</span><input style="width:50px;" id="tie_home_cats1[<?php echo $i ?>][openx]" name="tie_home_cats1[<?php echo $i ?>][openx]" value="<?php  echo isset($cat['openx']) ? $cat['openx'] : ''; ?>" type="text" /></label>
									<label for="tie_home_cats1[<?php echo $i ?>][excerpt]"><span>Show Excerpt:</span>
										<select id="tie_home_cats1[<?php echo $i ?>][excerpt]" name="tie_home_cats1[<?php echo $i ?>][excerpt]">
											<option value="n" <?php if ( $cat['excerpt'] == 'n') { echo ' selected="selected"' ; } ?>>No</option>
											<option value="y" <?php if ( $cat['excerpt'] == 'y') { echo ' selected="selected"' ; } ?>>Yes</option>
										</select>
									</label>
									<label for="tie_home_cats1[<?php echo $i ?>][text]"><span>After Widget HTML Code :</span><textarea cols="36" rows="5" name="tie_home_cats1[<?php echo $i ?>][text]" id="tie_home_cats1[<?php echo $i ?>][text]"><?php echo isset($cat['text']) ? stripslashes($cat['text']) : '' ; ?></textarea></label>
									<label for="tie_home_cats1[<?php echo $i ?>][cat_hide_children]"><span>Hide Category Children:</span>
										<select id="tie_home_cats1[<?php echo $i ?>][cat_hide_children]" name="tie_home_cats1[<?php echo $i ?>][cat_hide_children]">
											<option value="n" <?php if ( $cat['cat_hide_children'] != 'y' ) { echo ' selected="selected"' ; } ?>>No</option>
											<option value="y" <?php if ( $cat['cat_hide_children'] == 'y') { echo ' selected="selected"' ; } ?>>Yes</option>
										</select>
									</label>
								<?php
						...
						<?php
							...
							if($cats){
								...
								<?php 
									...
									<label for="tie_home_cats2[<?php echo $i ?>][openx]"><span>Openx Ad ID :</span><input style="width:50px;" id="tie_home_cats2[<?php echo $i ?>][openx]" name="tie_home_cats2[<?php echo $i ?>][openx]" value="<?php  echo isset($cat['openx']) ? $cat['openx'] : ''; ?>" type="text" /></label>
									<label for="tie_home_cats2[<?php echo $i ?>][excerpt]"><span>Show Excerpt:</span>
										<select id="tie_home_cats2[<?php echo $i ?>][excerpt]" name="tie_home_cats2[<?php echo $i ?>][excerpt]">
											<option value="n" <?php if ( $cat['excerpt'] == 'n') { echo ' selected="selected"' ; } ?>>No</option>
											<option value="y" <?php if ( $cat['excerpt'] == 'y') { echo ' selected="selected"' ; } ?>>Yes</option>
										</select>
									</label>
									<label for="tie_home_cats2[<?php echo $i ?>][text]"><span>After Widget HTML Code :</span><textarea cols="36" rows="5" name="tie_home_cats2[<?php echo $i ?>][text]" id="tie_home_cats2[<?php echo $i ?>][text]"><?php echo isset($cat['text']) ? stripslashes($cat['text']) : '' ; ?></textarea></label>
									<label for="tie_home_cats2[<?php echo $i ?>][cat_hide_children]"><span>Hide Category Children:</span>
										<select id="tie_home_cats2[<?php echo $i ?>][cat_hide_children]" name="tie_home_cats2[<?php echo $i ?>][cat_hide_children]">
											<option value="n" <?php if ( $cat['cat_hide_children'] != 'y' ) { echo ' selected="selected"' ; } ?>>No</option>
											<option value="y" <?php if ( $cat['cat_hide_children'] == 'y') { echo ' selected="selected"' ; } ?>>Yes</option>
										</select>
									</label>
								...
								<?php
									elseif( $cat['type'] == 'rev' ) :	?>
										...
										<div class="widget-content">
											<label for="tie_home_cats2[<?php echo $i ?>][title]"><span>Box Title :</span><input id="tie_home_cats2[<?php echo $i ?>][title]" name="tie_home_cats2[<?php echo $i ?>][title]" value="<?php   if( !empty($cat['title']) ) echo $cat['title']  ?>" type="text" /></label>
											<label for="tie_home_cats2[<?php echo $i ?>][link]"><span>Box Link :</span><input id="tie_home_cats2[<?php echo $i ?>][link]" name="tie_home_cats2[<?php echo $i ?>][link]" value="<?php  echo $cat['link']  ?>" type="text" /></label>
											...
											<label for="tie_home_cats2[<?php echo $i ?>][openx1]"><span>Openx Ad ID :</span><input style="width:50px;" id="tie_home_cats2[<?php echo $i ?>][openx1]" name="tie_home_cats2[<?php echo $i ?>][openx1]" value="<?php  echo isset($cat['openx1']) ? $cat['openx1'] : '';  ?>" type="text" /></label>
											<label for="tie_home_cats2[<?php echo $i ?>][text1]"><span>After Widget HTML Code :</span><textarea cols="36" rows="5" name="tie_home_cats2[<?php echo $i ?>][text1]" id="tie_home_cats2[<?php echo $i ?>][text1]"><?php echo isset($cat['text1']) ? stripslashes($cat['text1']) : '' ; ?></textarea></label>
											...
											<label for="tie_home_cats2[<?php echo $i ?>][openx2]"><span>Openx Ad ID :</span><input style="width:50px;" id="tie_home_cats2[<?php echo $i ?>][openx2]" name="tie_home_cats2[<?php echo $i ?>][openx2]" value="<?php  echo isset($cat['openx2']) ? $cat['openx2'] : ''; ?>" type="text" /></label>
											<label for="tie_home_cats2[<?php echo $i ?>][text2]"><span>After Widget HTML Code :</span><textarea cols="36" rows="5" name="tie_home_cats2[<?php echo $i ?>][text2]" id="tie_home_cats2[<?php echo $i ?>][text2]"><?php echo isset($cat['text3']) ? stripslashes($cat['text3']) : '' ; ?></textarea></label>
											...
											<label for="tie_home_cats2[<?php echo $i ?>][openx3]"><span>Openx Ad ID :</span><input style="width:50px;" id="tie_home_cats2[<?php echo $i ?>][openx3]" name="tie_home_cats2[<?php echo $i ?>][openx3]" value="<?php  echo isset($cat['openx3']) ? $cat['openx3'] : ''; ?>" type="text" /></label>
											<label for="tie_home_cats2[<?php echo $i ?>][text3]"><span>After Widget HTML Code :</span><textarea cols="36" rows="5" name="tie_home_cats2[<?php echo $i ?>][text3]" id="tie_home_cats2[<?php echo $i ?>][text3]"><?php echo isset($cat['text2']) ? stripslashes($cat['text2']) : '' ; ?></textarea></label>
								...
								<?php 
									if( $cat['type'] == 'n' ) :	?>
										...
										<div class="widget-content">
											...
											<label for="tie_home_cats3[<?php echo $i ?>][openx]"><span>Openx Ad ID :</span><input style="width:50px;" id="tie_home_cats3[<?php echo $i ?>][openx]" name="tie_home_cats3[<?php echo $i ?>][openx]" value="<?php  echo isset($cat['openx']) ? $cat['openx'] : ''; ?>" type="text" /></label>
											<label for="tie_home_cats3[<?php echo $i ?>][excerpt]"><span>Show Excerpt:</span>
												<select id="tie_home_cats3[<?php echo $i ?>][excerpt]" name="tie_home_cats3[<?php echo $i ?>][excerpt]">
													<option value="n" <?php if ( $cat['excerpt'] == 'n') { echo ' selected="selected"' ; } ?>>No</option>
													<option value="y" <?php if ( $cat['excerpt'] == 'y') { echo ' selected="selected"' ; } ?>>Yes</option>
												</select>
											</label>
											<label for="tie_home_cats3[<?php echo $i ?>][text]"><span>After Widget HTML Code :</span><textarea cols="36" rows="5" name="tie_home_cats3[<?php echo $i ?>][text]" id="tie_home_cats3[<?php echo $i ?>][text]"><?php echo isset($cat['text']) ? stripslashes($cat['text']) : '' ; ?></textarea></label>

									<label for="tie_home_cats3[<?php echo $i ?>][cat_hide_children]"><span>Hide Category Children:</span>
										<select id="tie_home_cats3[<?php echo $i ?>][cat_hide_children]" name="tie_home_cats3[<?php echo $i ?>][cat_hide_children]">
											<option value="n" <?php if ( $cat['cat_hide_children'] != 'y' ) { echo ' selected="selected"' ; } ?>>No</option>
											<option value="y" <?php if ( $cat['cat_hide_children'] == 'y') { echo ' selected="selected"' ; } ?>>Yes</option>
										</select>
									</label>
						...
						<?php
							...
							if($cats){
								...
								<?php 
									...
									<label for="tie_home_cats4[<?php echo $i ?>][openx]"><span>Openx Ad ID :</span><input style="width:50px;" id="tie_home_cats4[<?php echo $i ?>][openx]" name="tie_home_cats4[<?php echo $i ?>][openx]" value="<?php  echo $cat['openx']  ?>" type="text" /></label>
									<label for="tie_home_cats4[<?php echo $i ?>][excerpt]"><span>Show Excerpt:</span>
										<select id="tie_home_cats4[<?php echo $i ?>][excerpt]" name="tie_home_cats4[<?php echo $i ?>][excerpt]">
											<option value="n" <?php if ( $cat['excerpt'] == 'n') { echo ' selected="selected"' ; } ?>>No</option>
											<option value="y" <?php if ( $cat['excerpt'] == 'y') { echo ' selected="selected"' ; } ?>>Yes</option>
										</select>
									</label>
									 <label for="tie_home_cats4[<?php echo $i ?>][text]"><span>After Widget HTML Code :</span><textarea cols="36" rows="5" name="tie_home_cats4[<?php echo $i ?>][text]" id="tie_home_cats4[<?php echo $i ?>][text]"><?php echo stripslashes($cat['text']) ; ?></textarea></label>

									<label for="tie_home_cats4[<?php echo $i ?>][cat_hide_children]"><span>Hide Category Children:</span>
										<select id="tie_home_cats4[<?php echo $i ?>][cat_hide_children]" name="tie_home_cats4[<?php echo $i ?>][cat_hide_children]">
											<option value="n" <?php if ( $cat['cat_hide_children'] != 'y' ) { echo ' selected="selected"' ; } ?>>No</option>
											<option value="y" <?php if ( $cat['cat_hide_children'] == 'y') { echo ' selected="selected"' ; } ?>>Yes</option>
										</select>
									</label>
								...
								<?php
									elseif( $cat['type'] == 'rev' ) :	?>
										...
										<div class="widget-content">
											<label for="tie_home_cats4[<?php echo $i ?>][title]"><span>Box Title :</span><input id="tie_home_cats4[<?php echo $i ?>][title]" name="tie_home_cats4[<?php echo $i ?>][title]" value="<?php if( !empty($cat['title']) ) echo $cat['title']  ?>" type="text" /></label>
											<label for="tie_home_cats4[<?php echo $i ?>][link]"><span>Box Link :</span><input id="tie_home_cats4[<?php echo $i ?>][link]" name="tie_home_cats4[<?php echo $i ?>][link]" value="<?php  echo $cat['link']  ?>" type="text" /></label>
											<label><span>Box Category 1 : </span><select name="tie_home_cats4[<?php echo $i ?>][id1]" id="tie_home_cats4[<?php echo $i ?>][id1]">
												<?php foreach ($categories as $key => $option) { ?>
												<option value="<?php echo $key ?>" <?php if ( $cat['id1']  == $key) { echo ' selected="selected"' ; } ?>><?php echo $option; ?></option>
												<?php } ?>
											</select></label>
									<label for="tie_home_cats4[<?php echo $i ?>][openx1]"><span>Openx Ad ID :</span><input style="width:50px;" id="tie_home_cats4[<?php echo $i ?>][openx1]" name="tie_home_cats4[<?php echo $i ?>][openx1]" value="<?php  echo $cat['openx1']  ?>" type="text" /></label>
									<label for="tie_home_cats4[<?php echo $i ?>][text1]"><span>After Widget HTML Code :</span><textarea cols="36" rows="5" name="tie_home_cats4[<?php echo $i ?>][text1]" id="tie_home_cats4[<?php echo $i ?>][text1]"><?php echo stripslashes($cat['text1']) ; ?></textarea></label>
									...
									<label for="tie_home_cats4[<?php echo $i ?>][openx2]"><span>Openx Ad ID :</span><input style="width:50px;" id="tie_home_cats4[<?php echo $i ?>][openx2]" name="tie_home_cats4[<?php echo $i ?>][openx2]" value="<?php  echo $cat['openx2']  ?>" type="text" /></label>
									<label for="tie_home_cats4[<?php echo $i ?>][text2]"><span>After Widget HTML Code :</span><textarea cols="36" rows="5" name="tie_home_cats4[<?php echo $i ?>][text2]" id="tie_home_cats4[<?php echo $i ?>][text2]"><?php echo stripslashes($cat['text2']) ; ?></textarea></label>
									...
									<label for="tie_home_cats4[<?php echo $i ?>][openx3]"><span>Openx Ad ID :</span><input style="width:50px;" id="tie_home_cats4[<?php echo $i ?>][openx3]" name="tie_home_cats4[<?php echo $i ?>][openx3]" value="<?php  echo $cat['openx3']  ?>" type="text" /></label>
									<label for="tie_home_cats4[<?php echo $i ?>][text3]"><span>After Widget HTML Code :</span><textarea cols="36" rows="5" name="tie_home_cats4[<?php echo $i ?>][text3]" id="tie_home_cats4[<?php echo $i ?>][text3]"><?php echo stripslashes($cat['text3']) ; ?></textarea></label>
