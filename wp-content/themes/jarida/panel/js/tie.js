...
// HomeBuilder
	...
	jQuery(".tie_add-wide-cat").click(function() {
		var builderno = jQuery(this).attr('data-num');
		var builderID = jQuery(this).attr('data-id');
        jQuery(builderID).append('	<li id="listItem_'+ nextCell +'" class="ui-state-default"><div class="widget-head"> News Box <a style="display:none" class="toggle-open">+</a><a style="display:block" class="toggle-close">-</a></div><div style="display:block" class="widget-content"><label><span>Box Category : </span><select name="tie_home_cats'+builderno+'['+ nextCell +'][id]" id="tie_home_cats'+builderno+'['+ nextCell +'][id]">'+htm1l+'</select></label><label><span>Posts Order : </span><select name="tie_home_cats'+builderno+'['+ nextCell +'][order]" id="tie_home_cats'+builderno+'['+ nextCell +'][order]"><option value="latest" selected="selected">Latest Posts</option><option value="rand">Random Posts</option></select></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats'+builderno+'['+ nextCell +'][number]" name="tie_home_cats'+builderno+'['+ nextCell +'][number]" value="4" type="text" /></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][openx]"><span>Openx Ad ID:</span><input style="width:50px;" id="tie_home_cats'+builderno+'['+ nextCell +'][openx]" name="tie_home_cats'+builderno+'['+ nextCell +'][openx]" value="" type="text"></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][text]"><span>After Widget HTML Code :</span><textarea cols="36" rows="5" name="tie_home_cats'+builderno+'['+ nextCell +'][text]" id="tie_home_cats'+builderno+'['+ nextCell +'][text]"></textarea></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][excerpt]"><span>Show Excerpt:</span><select id="tie_home_cats'+builderno+'['+ nextCell +'][excerpt]" name="tie_home_cats'+builderno+'['+ nextCell +'][excerpt]"><option value="n">No</option><option value="y">Yes</option></select></label><input id="tie_home_cats'+builderno+'['+ nextCell +'][type]" name="tie_home_cats'+builderno+'['+ nextCell +'][type]" value="n" type="hidden" /><a class="del-cat"></a></div></li>');
		jQuery('#listItem_'+ nextCell).hide().fadeIn();
		nextCell ++ ;
	});	
	...
	jQuery(".tie_add-wide-reviews").click(function() {
		var builderno = jQuery(this).attr('data-num');
		var builderID = jQuery(this).attr('data-id');
        jQuery(builderID).append('	<li id="listItem_'+ nextCell +'" class="ui-state-default"><div class="widget-head"> Reviews Box <a style="display:none" class="toggle-open">+</a><a style="display:block" class="toggle-close">-</a></div><div style="display:block" class="widget-content"><label for="tie_home_cats'+builderno+'['+ nextCell +'][title]"><span>Box Title :</span><input id="tie_home_cats'+builderno+'['+ nextCell +'][title]" name="tie_home_cats'+builderno+'['+ nextCell +'][title]" value="Best Reviews" type="text" /></label><label><span>Box Category 1 : </span><select name="tie_home_cats'+builderno+'['+ nextCell +'][id1]" id="tie_home_cats'+builderno+'['+ nextCell +'][id1]">'+htm1l+'</select></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][openx1]"><span>Openx Ad ID 1:</span><input style="width:50px;" id="tie_home_cats'+builderno+'['+ nextCell +'][openx1]" name="tie_home_cats'+builderno+'['+ nextCell +'][openx1]" value="" type="text"></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][text1]"><span>After Widget HTML Code :</span><textarea cols="36" rows="5" name="tie_home_cats'+builderno+'['+ nextCell +'][text1]" id="tie_home_cats'+builderno+'['+ nextCell +'][text1]"></textarea></label><label><span>Box Category 2 : </span><select name="tie_home_cats'+builderno+'['+ nextCell +'][id2]" id="tie_home_cats'+builderno+'['+ nextCell +'][id2]">'+htm1l+'</select></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][openx2]"><span>Openx Ad ID 2:</span><input style="width:50px;" id="tie_home_cats'+builderno+'['+ nextCell +'][openx2]" name="tie_home_cats'+builderno+'['+ nextCell +'][openx2]" value="" type="text"></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][text2]"><span>After Widget HTML Code :</span><textarea cols="36" rows="5" name="tie_home_cats'+builderno+'['+ nextCell +'][text2]" id="tie_home_cats'+builderno+'['+ nextCell +'][text2]"></textarea></label><label><span>Box Category 3 : </span><select name="tie_home_cats'+builderno+'['+ nextCell +'][id3]" id="tie_home_cats'+builderno+'['+ nextCell +'][id3]">'+htm1l+'</select></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][openx3]"><span>Openx Ad ID 3:</span><input style="width:50px;" id="tie_home_cats'+builderno+'['+ nextCell +'][openx3]" name="tie_home_cats'+builderno+'['+ nextCell +'][openx3]" value="" type="text"></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][text3]"><span>After Widget HTML Code :</span><textarea cols="36" rows="5" name="tie_home_cats'+builderno+'['+ nextCell +'][text3]" id="tie_home_cats'+builderno+'['+ nextCell +'][text3]"></textarea></label><label><span>Posts Order : </span><select name="tie_home_cats'+builderno+'['+ nextCell +'][order]" id="tie_home_cats'+builderno+'['+ nextCell +'][order]"><option value="latest" selected="selected">Latest Reviews</option><option value="rand">Random Reviews</option><option value="best">Best Reviews</option></select></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats'+builderno+'['+ nextCell +'][number]" name="tie_home_cats'+builderno+'['+ nextCell +'][number]" value="4" type="text" /></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][excerpt]"><span>Show Excerpt:</span><select id="tie_home_cats'+builderno+'['+ nextCell +'][excerpt]" name="tie_home_cats'+builderno+'['+ nextCell +'][excerpt]"><option value="n">No</option><option value="y">Yes</option></select></label><input id="tie_home_cats'+builderno+'['+ nextCell +'][type]" name="tie_home_cats'+builderno+'['+ nextCell +'][type]" value="rev" type="hidden" /><a class="del-cat"></a></div></li>');
		jQuery('#listItem_'+ nextCell).hide().fadeIn();
		nextCell ++ ;
	});
