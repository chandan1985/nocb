...
class tie_counter_widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$dribbble_api 	= $instance['dribbble_api'];
		...
		<div class="widget widget-counter col<?php echo $counter; ?>">
			<ul>
				...
				<?php endif; ?>
				<?php if( $dribbble_url && $dribbble_api ):
					$dribbble = tie_dribbble_count( $dribbble_url, $dribbble_api ); ?>
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['dribbble_api'] 	=  $new_instance['dribbble_api'] ;
	...
	function form( $instance ) {
		...
		<p style="border-bottom: 1px solid #DDD;padding-bottom: 10px;">
			...
			<input id="<?php echo $this->get_field_id( 'youtube' ); ?>" name="<?php echo $this->get_field_name( 'youtube' ); ?>" value="<?php echo isset($instance['youtube']) ? $instance['youtube'] : ''; ?>" class="widefat" type="text" />
			...
			<input id="<?php echo $this->get_field_id( 'youtube_api' ); ?>" name="<?php echo $this->get_field_name( 'youtube_api' ); ?>" value="<?php echo isset($instance['youtube_api']) ? $instance['youtube_api'] : ''; ?>" class="widefat" type="text" />
		...
		<p style="border-bottom: 1px solid #DDD;padding-bottom: 10px;">
			...
			<label for="<?php echo $this->get_field_id( 'dribbble_api' ); ?>">API Key : </label>
			<input id="<?php echo $this->get_field_id( 'dribbble_api' ); ?>" name="<?php echo $this->get_field_name( 'dribbble_api' ); ?>" value="<?php echo isset($instance['dribbble_api']) ? $instance['dribbble_api'] : ''; ?>" class="widefat" type="text" />
