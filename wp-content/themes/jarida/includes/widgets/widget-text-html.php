...
class tie_text_html extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		// use old title var name if needed
		if ((empty($instance['title']) or $instance['title'] == 'Text') and !empty($instance['text_html_title'])) {$instance['title'] = $instance['text_html_title'];}
	...
	function form( $instance ) {
		...
		<p>
			...
			<input id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php if( !empty($instance['title']) and $instance['title'] != 'Text' ) {echo $instance['title']; } else {echo isset($instance['text_html_title']) ? $instance['text_html_title'] : '';} ?>" class="widefat" type="text" />
		</p>
