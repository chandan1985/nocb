<?php
/*
  Template Name: Thank You Page Jobtrac
 */
?>
<?php
...
<div class="content-wrap">
    ...
    <?php
        ...
        $unserialize_array =  unserialize($results['0']->option_value);        
            ...
            $message = '<div><div><span style="color: #555555; font-family: Verdana, sans-serif; font-size: medium;">Thank you for subscribing to <em>JobTrac</em></span><span style="color: #555555; font-family: Verdana, sans-serif; font-size: medium;">. We are pleased that you have chosen us to be your trusted provider of construction data and news in Wisconsin.</span></div><div><span style="color: #555555; font-family: Verdana, sans-serif; font-size: small;">&nbsp;</span></div><div><span style="color: #555555; font-family: Verdana, sans-serif; font-size: medium;">In addition to the subscription you purchased, you also have access to:</span></div><div><span style="color: #555555; font-family: Verdana, sans-serif; font-size: small;">&nbsp;</span></div><ul><li><span style="color: #555555; font-family: Calibri, sans-serif; font-size: small;"><span style="font-family: Verdana, sans-serif; font-size: medium;">24/7 digital access at <a href="http://dailyreporter.com">dailyreporter.com</a></span></span></li><li><span style="color: #555555; font-family: Calibri, sans-serif; font-size: small;"><span style="font-family: Verdana, sans-serif; font-size: medium;">The digital edition at&nbsp;<a href="http://dailyreporter.com/e-edition">http://dailyreporter.com/e-edition</a></span></span></li></ul><div><span style="color: #555555; font-family: Verdana, sans-serif; font-size: small;">&nbsp;</span></div><div><span style="color: #555555; font-family: Verdana, sans-serif; font-size: medium;">Stay connected with us online on <a href="https://www.facebook.com/JobTrac ">Facebook</a> and <a href="https://twitter.com/WIJobTrac">Twitter</a></span></div><div><span style="color: #555555; font-family: Verdana, sans-serif; font-size: medium;"><br />We hope to see you at one of our upcoming events and encourage you to nominate.</span></div><div>&nbsp;</div></div><div><div><span style="color: purple; font-family: Verdana, sans-serif; font-size: medium;">If you have any questions or problems, please visit our <a href="http://dailyreporter.com/frequently-asked-questions/">Frequently Asked Questions</a> page on our website, or contact us at&nbsp;</span><a href="tel:8776159536"><span style="font-family: Verdana, sans-serif; font-size: medium;"><span style="color: purple;">877-615-9536</span></span></a><span style="color: purple; font-family: Verdana, sans-serif; font-size: medium;">&nbsp;or </span><a href="mailto:service@bridgetowermedia.com"><span style="font-family: Verdana, sans-serif; font-size: medium;"><span style="color: purple;">service@bridgetowermedia.com</span></span></a></div></div>';
        ...
        //For Jobtrac User Insertion 
            $jobtrac_enable = $unserialize_array['jobtrac_enable'];
            if ($jobtrac_enable == 'yes') {
                $service_code = $_POST['service_code'];
                if($service_code == 'JP' || $service_code == 'JD' || $service_code == 'JS')
                  {
                    $external_user_ID = $_POST['external_user_ID'];
                    $external_password = $_POST['external_password'];
                    $transaction_first_name = $_POST['transaction_first_name'];
                    $transaction_last_name = $_POST['transaction_last_name'];
                    $rowguid = '';
                    $isdolan = 0;
                    $companyname = $_POST['transaction_company'];
        ...
        //For Jobtrac User Insertion End Here
