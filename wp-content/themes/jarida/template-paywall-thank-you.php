<?php
/*
  Template Name: Thank You Page Paywall
 */
?>
<?php
...
wp_reset_query(); //resetting the page query
		...
		if ($_COOKIE['site_referrer']) {
                $site_refer_url = $_COOKIE['site_referrer'];
                ?>
                <br>
        <a style="color: red;font-size: 15px;" href='<?php echo $site_refer_url;?>'><p> >> Return to <span style="font-style: oblique;" ><?php echo get_bloginfo( 'name' ); ?></span> - Public Notice</p></a>
                <?php
                }
        global $wpdb;            
        ...
        $unserialize_array =  unserialize($results['0']->option_value);           
            ...
            $message = $unserialize_array['thankyou_msg'];
		...
		//Acton API Call Start here
		
		if (!empty($_REQUEST['e_mail_1'])) {
