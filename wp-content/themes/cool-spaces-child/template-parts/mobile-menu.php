<?php 
wp_enqueue_style( 'mobilemenucss', get_template_directory_uri() . '/css/mobilemenu.css' );
wp_enqueue_script( 'mobilemenujs', get_template_directory_uri() . '/js/mobilemenu.js');
?>
<div class="mobile-menu-container">
	...
	/*get the mobile and mobile footer menus */
		wp_multisite_nav_menu( array('theme_location'=>'mobile', 'depth'=>3, 'container_class'=>'mobile_menu', 'menu_id'=>'mobile_menu') );
	 ?>
	
	<?php
	if ( has_nav_menu( 'mobile-footer' ) ) {
			wp_multisite_nav_menu( array('theme_location'=>'mobile-footer', 'depth'=>1, 'container_class'=>'mobile_footer_menu', 'menu_id'=>'mobile_footer_menu') );
	}
	?>
