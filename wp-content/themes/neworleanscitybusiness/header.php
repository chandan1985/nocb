...
if($current_path == "/subscribe/" || in_array('print-digital', $path_array) || $current_path == "/thank-you/"){
	$hide_section = "d-none";
...
?>
    <div id="page" class="site">
        <a class="skip-link screen-reader-text"
            href="#primary"><?php esc_html_e( 'Skip to content', 'neworleanscitybusiness' ); ?></a>
        ...
        <div class="mobile-whole-header">
            ...
            <div class="mobile-header-bottom-adboard-area">
                <div class="container">
                    <?php
					if ($template_name != 'template-blank.php'){
                        if (is_array($hide_from_posts) && is_array($hide_from_pages)) {
        ...
        <div class="whole-header <?php print $display_none; ?>">
            <?php if( is_array($top_billboard_hide_from_post_type) && is_array($top_billboard_hide_from_pages) ){?>
                <?php if(!in_array($current_post_type, $top_billboard_hide_from_post_type) && !in_array(get_the_ID(), $top_billboard_hide_from_pages)){ ?>
                    <div class="top-billboard-area <?php print $hide_section; ?>">
                        <?php if($template_name != 'template-blank.php'){ ?>
                            <div class="container text-center"><?php print do_shortcode($top_billboard); ?></div>
                        <?php } ?>
                    </div>
                <?php } ?>
            <?php } ?>
        ...
        <div class="header-bottom-adboard-area <?php print $hide_leaderboard; ?>">
            <div class="container">
                <?php
				if(isset($hide_from_posts) && is_array($hide_from_posts) &&
                isset($hide_from_pages) && is_array($hide_from_pages) && !in_array($current_post_type, $hide_from_posts) && !in_array(get_the_ID(), $hide_from_pages)){
                ...
                <?php 
					//if($template_name != 'template-blank.php'){
                       ...
                       // }
                        ...
                        if( is_array( $hide_welcome_ad ) && !in_array( get_the_ID(), $hide_welcome_ad )){
                            print do_shortcode($welcome_ad); 
                        }
        ...
        <div class="pop-out-menu-area" id="pop-out-menu-region">
            <div class="pop-out-menu">
                <div class="widget_nav_menu"><?php wp_nav_menu($selected_popup_menu); ?></div>
            </div>
        </div>
        <!-- Desktop header end -->
        <?php } 
