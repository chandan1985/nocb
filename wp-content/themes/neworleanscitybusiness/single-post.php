...
if (!empty($byline_author['name'][0])) {
    $byline_author_name = $byline_author['name'][0];
}
$cmpnyId = get_post_meta($id, 'associated_sponsor_id', true);
$pbm_featured_image_show = get_post_meta($id, 'pbm_featured_image_show', true);
...
<div class="article-detail-page container">
            ...
            <div class="newsdetail-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 social-share-links">
						...
						echo '<li><a class="email" href="mailto:?subject='.get_the_title($post_id).'&amp;body='.esc_html($eventContent).'" title="Share by Email"><img src="/wp-content/themes/neworleanscitybusiness/images/email.svg" alt="email"></a></li>';
						echo '</ul>';
						?>
                    </div>
                </div>
    ...
    <!-- End row -->
    <?php
    if (is_array($footer_hide_from_post_type) && is_array($footer_hide_from_pages)) {
