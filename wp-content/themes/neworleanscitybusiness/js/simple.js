jQuery(document).ready(function () {
    ...
    jQuery("#menu-main-navigationnew-navigation .menu-item-has-children").hover(function () {
...
$('.newsdetail-wrapper .news-detail').contents().filter(function(){
