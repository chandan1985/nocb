<?php
    // Category mobile pagination section.....
    add_action('wp_ajax_ajax_categoryMobile', 'load_more_categrories_in_mobile');
    add_action( 'wp_ajax_nopriv_ajax_categoryMobile', 'load_more_categrories_in_mobile' );

    function load_more_categrories_in_mobile() {
