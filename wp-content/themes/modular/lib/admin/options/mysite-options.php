...
$options = array(
	...
	array(
		...
		array(
			'name' => __( 'Custom Post Types for SEO Column Support', MYSITE_ADMIN_TEXTDOMAIN ),
			'desc' => __( 'Choose which post types you want to have SEO columns on the edit.php screen.', MYSITE_ADMIN_TEXTDOMAIN ),
